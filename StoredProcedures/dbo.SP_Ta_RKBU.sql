...
CREATE PROCEDURE [dbo].[SP_Ta_RKBU] @Tahun varchar(4), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(3)
WITH ENCRYPTION
AS
	SELECT A.Tahun, A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.No_ID,
		...
		A.Merk, A.Type, A.Ukuran, A.Jumlah, A.Harga, A.Jumlah * A.Harga AS Total,
