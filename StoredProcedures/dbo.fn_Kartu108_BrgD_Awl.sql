...
CREATE FUNCTION dbo.fn_Kartu108_BrgD_Awl (@D1 Datetime, @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(4),
...
RETURNS @UpdateKIB TABLE(Kd_Prov tinyint, Kd_Kab_Kota tinyint,  Kd_Bidang tinyint, Kd_Unit smallint, Kd_Sub smallint, Kd_UPB int, 
			 ...
			 Asal_usul Varchar(50), Kondisi Varchar(2), Harga money, Masa_Manfaat int, Nilai_Sisa money, Keterangan Varchar (255), Kd_KA tinyint)
...
DECLARE @tmpHarga TABLE(Kd_ID int, Kd_Riwayat tinyint, Kd_Prov tinyint, Kd_Kab_Kota tinyint, Kd_Bidang tinyint, Kd_Unit smallint, Kd_Sub smallint, Kd_UPB int, 
						Kd_ASet tinyint,Kd_ASet0 tinyint,Kd_Aset1 tinyint, Kd_Aset2 tinyint, Kd_Aset3 tinyint, Kd_Aset4 smallint, Kd_Aset5 smallint, No_Register int, Harga money, Masa_Manfaat MONEY, Nilai_Sisa money, Kd_Data tinyint, Kd_KA tinyint)
DECLARE @UbahData TABLE(Kd_Prov tinyint, Kd_Kab_Kota tinyint,  Kd_Bidang tinyint, Kd_Unit smallint, Kd_Sub smallint, Kd_UPB int,  
						...
						Asal_usul Varchar(50), Kondisi Varchar(2), Harga money, Masa_Manfaat int, Nilai_Sisa money, Keterangan Varchar (255))
...
--UBAH DATA KIB D (RIWAYAT)
  ...
  INSERT INTO @UpdateKIB
   SELECT A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, 
		...
		B.Kd_Tanah1, B.Kd_Tanah2, B.Kd_Tanah3, B.Kd_Tanah4, B.Kd_Tanah5, B.Kode_Tanah, B.Asal_usul, B.Kondisi, A.Harga, B.Masa_Manfaat, B.Nilai_Sisa, B.Keterangan, A.Kd_KA
   FROM(
	SELECT A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, 
	...
	FROM @UBAHDATA A 
			 ...
			 A.Kd_ASet = B.Kd_ASet AND A.Kd_ASet0 = B.Kd_ASet0 AND  A.Kd_ASet1 = B.Kd_ASet1 
