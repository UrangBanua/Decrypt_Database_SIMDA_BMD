...
CREATE PROCEDURE [dbo].[SP_Ta_GunaKIBE] @SK_Guna varchar(50)
WITH ENCRYPTION
AS
...
SELECT Kd_Prov, Kd_Kab_Kota, Kd_Bidang, Kd_Unit, Kd_Sub, Kd_UPB, Kd_Aset1, Kd_Aset2, Kd_Aset3, Kd_Aset4, Kd_Aset5, No_Register,
	Kd_Ruang, Kd_Pemilik, Tgl_Perolehan, Tgl_Pembukuan, Judul, Pencipta, Bahan, Ukuran, Asal_usul, Kondisi, Harga, Masa_Manfaat,
