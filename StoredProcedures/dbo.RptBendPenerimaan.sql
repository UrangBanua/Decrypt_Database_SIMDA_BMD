...
create PROCEDURE RptBendPenerimaan @Tahun varchar(4), @Kd_Urusan varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @D1 datetime, @Level tinyint, @Kd_Rek_1 varchar(1), @Kd_Rek_2 varchar(3), @Kd_Rek_3 varchar(3), @Kd_Rek_4 varchar(3), @Kd_Rek_5 varchar(3)
WITH ENCRYPTION
AS
/*
...
*/
	...
	where (F.KD_JAB=3)AND F.TAHUN=@Tahun
