...
/*** RptRekapKIB_E_Gabungan - 05012016 - Modified for Ver 2.0.7 [demi@simda.id] ***/
CREATE PROCEDURE dbo.RptRekapKIB_E_Gabungan @Tahun varchar(4), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(3), @D2 datetime
WITH ENCRYPTION
AS
...
*/
	...
	DECLARE @Ta_KIB_E TABLE(Kd_Prov tinyint, Kd_Kab_Kota tinyint, Kd_Bidang tinyint, Kd_Unit smallint, Kd_Sub smallint, Kd_UPB smallint, Kd_Pemilik tinyint, Kd_Aset1 tinyint, Kd_Aset2 tinyint, Kd_Aset3 tinyint, Kd_Aset4 tinyint, Kd_Aset5 tinyint, Reg1 int, Reg2 int, JudulPencipta varchar(500), Spesifikasi varchar(50), AsalDaerah varchar(50), Tahun smallint, Pencipta varchar(50), Bahan varchar(50), Jenis varchar(50), Ukuran varchar(10), Satuan varchar(50), Asal_usul varchar(50), Harga money, Total int, Keterangan varchar(255))
	...
	SELECT 	A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_UPB, I.Nm_Provinsi, 
		...
		A.Satuan, A.Total, A.Tahun, A.Asal_usul, A.Harga / 1000 AS Harga, A.Keterangan, --G.Logo,
	...
	GROUP BY A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_UPB, I.Nm_Provinsi, H.Nm_Kab_Kota, F.Nm_Bidang, E.Nm_Unit, D.Nm_Sub_Unit, L.Nm_UPB, A.Kd_Pemilik, A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB,
		B.Nm_Aset5, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.Reg1, A.Reg2, 
		A.JudulPencipta, A.Spesifikasi, A.AsalDaerah, A.Pencipta, A.Bahan, A.Jenis, A.Ukuran, A.Satuan, A.Total, A.Tahun, A.Asal_usul, A.Harga, A.Keterangan,
		K.Nm_Pimpinan, K.Nip_Pimpinan, K.Jbt_Pimpinan, K.Nm_Pengurus, K.Nip_Pengurus, K.Jbt_Pengurus
	ORDER BY A.Kd_Kab_Kota, A.Kd_UPB, Kd_Gab_Brg, No_Register
