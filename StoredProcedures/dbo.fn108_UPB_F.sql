...
CREATE FUNCTION dbo.fn108_UPB_F (@D2 Datetime, @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(4),
	...
	FROM
		...
		SELECT	A.IDPemda, A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, 
			A.Kd_Aset8 AS Kd_Aset,A.Kd_Aset80 AS Kd_Aset0,A.Kd_Aset81  AS Kd_Aset1, A.Kd_Aset82 AS Kd_Aset2, A.Kd_Aset83 AS Kd_Aset3, 
				A.Kd_Aset84 AS Kd_Aset4,A.Kd_Aset85 AS Kd_Aset5, A.No_Register, 
