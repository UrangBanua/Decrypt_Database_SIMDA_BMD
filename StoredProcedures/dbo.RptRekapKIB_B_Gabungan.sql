...
/*** RptRekapKIB_B_Gabungan - 05012016 - Modified for Ver 2.0.7 [demi@simda.id] ***/ 
CREATE PROCEDURE dbo.RptRekapKIB_B_Gabungan @Tahun varchar(4), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(3), @D2 datetime
WITH ENCRYPTION
AS
...
*/
	...
	WHERE /*(YEAR(A.Tgl_Pembukuan) <= @TAHUN) AND*/ (A.Kd_Prov = @Kd_Prov) AND (A.Kd_Kab_Kota LIKE @Kd_Kab_Kota) AND (A.Kd_Bidang LIKE @Kd_Bidang) AND (A.Kd_Unit LIKE @Kd_Unit) AND (A.Kd_Sub LIKE @Kd_Sub) AND (A.Kd_UPB LIKE @Kd_UPB)
	...
	SELECT 	A.Kd_Prov, A.Kd_Kab_Kota, K.Kd_UPB, I.Nm_Provinsi, H.Nm_Kab_Kota,
		F.Nm_Bidang, E.Nm_Unit, D.Nm_Sub_Unit, K.Nm_UPB,
		...
		A.Asal_usul, A.Harga / 1000 AS Harga, --G.Logo,
	...
	FROM 	@Ta_KIB_B A INNER JOIN
		...
		Ref_UPB K ON A.Kd_Prov = K.Kd_Prov AND A.Kd_Kab_Kota = K.Kd_Kab_Kota AND A.Kd_Bidang = K.Kd_Bidang AND A.Kd_Unit = K.Kd_Unit AND A.Kd_Sub = K.Kd_Sub AND A.Kd_UPB = K.Kd_UPB,
		(
	...
	GROUP BY A.Kd_Prov, A.Kd_Kab_kota, K.Kd_UPB, I.Nm_Provinsi, H.Nm_Kab_Kota, F.Nm_Bidang, E.Nm_Unit, D.Nm_Sub_Unit, K.Nm_UPB, A.Kd_UPB, A.Kd_Sub, A.Kd_Unit,
		A.Kd_Bidang, A.Kd_Kab_Kota, A.Kd_Prov, A.Kd_UPB, A.Kd_Sub, A.Kd_Unit, A.Kd_Bidang, A.Kd_Kab_Kota, A.Kd_Prov, A.Kd_Pemilik, B.Nm_Aset5,
		A.Kd_Aset5, A.Kd_Aset4, A.Kd_Aset3, A.Kd_Aset2, A.Kd_Aset1, A.Reg1, A.Reg2, A.MerkType, A.CC, A.Bahan, A.Tahun, A.Nomor_PAbrik, A.Nomor_Rangka,
		A.Nomor_Mesin, A.Nomor_BPKB, A.Keterangan, A.Asal_Usul, A.Harga, A.Total, A.Nomor_polisi,
		L.Nm_Pimpinan, L.Nip_Pimpinan, L.Jbt_Pimpinan, L.Nm_Pengurus, L.Nip_Pengurus, L.Jbt_Pengurus
	ORDER BY A.Kd_Kab_Kota, K.Kd_UPB, Kd_Gab_Brg, No_Register, A.Tahun
