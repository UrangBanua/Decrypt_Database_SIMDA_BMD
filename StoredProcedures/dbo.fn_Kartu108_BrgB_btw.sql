...
CREATE FUNCTION dbo.fn_Kartu108_BrgB_btw (@D1 datetime, @D2 Datetime, @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(3),
...
RETURNS @UpdateKIB TABLE(Kd_Prov tinyint, Kd_Kab_Kota tinyint,  Kd_Bidang tinyint, Kd_Unit smallint, Kd_Sub smallint, Kd_UPB int, 
		         Kd_ASet tinyint,Kd_ASet0 tinyint,Kd_ASet1 tinyint, Kd_Aset2 tinyint, Kd_Aset3 tinyint, Kd_Aset4 smallint, Kd_Aset5 smallint, No_Register int, Kd_Ruang int, Kd_Pemilik tinyint, Harga Money, Masa_Manfaat smallint,  Nilai_Sisa Money, Tgl_Dokumen Datetime,
...
DECLARE @tmpHarga TABLE(Kd_ID int, Kd_Riwayat tinyint, Kd_Prov tinyint, Kd_Kab_Kota tinyint, Kd_Bidang tinyint, Kd_Unit smallint, Kd_Sub smallint, Kd_UPB int, 
						Kd_ASet tinyint,Kd_ASet0 tinyint, Kd_Aset1 tinyint, Kd_Aset2 tinyint, Kd_Aset3 tinyint, Kd_Aset4 smallint, Kd_Aset5 smallint, No_Register int, Harga money, Masa_Manfaat smallint, Nilai_Sisa money, Kd_Data tinyint, Kd_KA tinyint, Kd_Mutasi Tinyint, Jml_Brg int)
...
--2. PEROLEHAN 2
	...
	FROM	Ta_KIBBR A INNER JOIN Ta_KIB_C B ON A.Kd_Prov1 = B.Kd_Prov AND A.Kd_Kab_Kota1 = B.Kd_Kab_Kota 
            AND A.Kd_Bidang1 = B.Kd_Bidang AND A.Kd_Unit1 = B.Kd_Unit AND A.Kd_Sub1 = B.Kd_Sub AND A.Kd_UPB1 = B.Kd_UPB 
            AND A.Kd_Aset8 = B.Kd_Aset8 AND A.Kd_Aset80 = B.Kd_Aset80 AND A.Kd_Aset81 = B.Kd_Aset81 AND A.Kd_Aset82 = B.Kd_Aset82 AND A.Kd_Aset83 = B.Kd_Aset83 AND 
...
--Perbaikan mutasi jika ada penghapusan tidak masuk lagi--12/12/13
	...
	SELECT	  MAX(A.Kd_ID)AS Kd_ID, A.Kd_Riwayat, A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, 
		A.Kd_ASet8, A.Kd_ASet80, A.Kd_ASet81, A.Kd_Aset82, A.Kd_Aset83, A.Kd_Aset84, A.Kd_Aset85, A.No_Register,  
		ISNULL(SUM(A.Harga),0) AS Harga, ISNULL(SUM(A.Masa_Manfaat),0) AS Masa_Manfaat, ISNULL(SUM(A.Nilai_Sisa),0) AS Nilai_Sisa, A.Kd_Data, NULL AS Kd_Data, 4 AS Kd_Mutasi, 0 AS Jml_Brg
...
--5. HAPUS SEBAGIAN
	...
	SELECT	 MAX(A.Kd_ID)AS Kd_ID, A.Kd_Riwayat, A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, 
		A.Kd_ASet8, A.Kd_ASet80, A.Kd_ASet81, A.Kd_Aset82, A.Kd_Aset83, A.Kd_Aset84, A.Kd_Aset85, A.No_Register, 
		ISNULL(SUM(Harga),0) AS Harga, ISNULL(SUM(A.Masa_Manfaat),0) AS Masa_Manfaat, ISNULL(SUM(A.Nilai_Sisa),0) AS Nilai_Sisa, A.Kd_Data, NULL AS Kd_Data, 5 AS Kd_Mutasi, 0 AS Jml_Brg
	FROM	Ta_KIBBR A
...
--Perbaikan mutasi jika ada penghapusan tidak masuk lagi--12/12/13
	...
	WHERE	(A.Tgl_Dokumen BETWEEN @D1 AND @D2) AND (A.Tgl_Pembukuan <= @D2) AND (A.Kd_Riwayat = 21) AND (A.Kd_Data <> 3) AND (A.Kd_Prov = @Kd_Prov) AND (A.Kd_Kab_Kota = @Kd_Kab_Kota) AND (A.Kd_Bidang LIKE @Kd_Bidang) AND (A.Kd_Unit LIKE @Kd_Unit) AND (A.Kd_Sub LIKE @Kd_Sub) AND (A.Kd_UPB LIKE @Kd_UPB) AND
			(A.Kd_Aset8 LIKE @Kd_Aset) AND (A.Kd_Aset80 LIKE @Kd_Aset0) AND (A.Kd_Aset81 LIKE @Kd_Aset1) AND (A.Kd_Aset82 LIKE @Kd_Aset2) AND (A.Kd_Aset83 LIKE @Kd_Aset3) AND (A.Kd_Aset84 LIKE @Kd_Aset4) AND (A.Kd_Aset85 LIKE @Kd_Aset5) AND (A.No_Register LIKE @No_Register)
		AND B.Kd_Prov IS NULL
	GROUP BY B.Tgl_SK, A.Kd_ID, A.Kd_Riwayat, A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, 
			A.Kd_ASet8, A.Kd_ASet80, A.Kd_ASet81, A.Kd_Aset82, A.Kd_Aset83, A.Kd_Aset84, A.Kd_Aset85, A.No_Register, 
			A.Kd_Data
	...
	SELECT  A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, 
			A.Kd_ASet8, A.Kd_ASet80, A.Kd_ASet81, A.Kd_Aset82, A.Kd_Aset83, A.Kd_Aset84, A.Kd_Aset85, A.No_Register,  
			A.Kd_Ruang, A.Kd_Pemilik, A.Merk, A.Type, A.CC, A.Bahan, A.Tgl_DOKUMEN, 'Data KIB' AS No_Dokumen, 
			A.Tgl_Perolehan, A.Tgl_Pembukuan, A.Nomor_Pabrik, A.Nomor_Rangka, A.Nomor_Mesin, A.Nomor_Polisi, 
	       A.Nomor_BPKB, A.Asal_usul, A.Kondisi, A.Harga, A.Masa_Manfaat, A.Nilai_Sisa, A.Keterangan, A.Tahun
	FROM 
	(
		SELECT  A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, 
				A.Kd_ASet8, A.Kd_ASet80, A.Kd_ASet81, A.Kd_Aset82, A.Kd_Aset83, A.Kd_Aset84, A.Kd_Aset85, A.No_Register,  
				A.Kd_Ruang, A.Kd_Pemilik, A.Merk, A.Type, A.CC, A.Bahan, '' AS TGL_DOKUMEN, 'Data KIB' AS No_Dokumen, 
				A.Tgl_Perolehan, A.Tgl_Pembukuan, A.Nomor_Pabrik, A.Nomor_Rangka, A.Nomor_Mesin, A.Nomor_Polisi, 
			    A.Nomor_BPKB, A.Asal_usul, A.Kondisi, A.Harga, A.Masa_Manfaat, A.Nilai_Sisa, A.Keterangan, A.Tahun
		FROM Ta_KIB_B A 
...
--2(hapus)
	...
	SELECT  A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, 
			A.Kd_ASet8, A.Kd_ASet80, A.Kd_ASet81, A.Kd_Aset82, A.Kd_Aset83, A.Kd_Aset84, A.Kd_Aset85, A.No_Register, 
			A.Kd_Ruang, A.Kd_Pemilik, A.Merk, A.Type, A.CC, A.Bahan, A.Tgl_Perolehan AS Tgl_Dokumen, 'Data KIB' AS No_Dokumen, 
			A.Tgl_Perolehan, A.Tgl_Pembukuan, A.Nomor_Pabrik, A.Nomor_Rangka, A.Nomor_Mesin, A.Nomor_Polisi, 
	       A.Nomor_BPKB, A.Asal_usul, A.Kondisi, A.Harga, A.Masa_Manfaat, A.Nilai_Sisa, A.Keterangan, A.Tahun
...
--UBAH DATA KIB B (RIWAYAT)
	...
	SELECT   A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, 
			A.Kd_ASet8, A.Kd_ASet80, A.Kd_ASet81, A.Kd_Aset82, A.Kd_Aset83, A.Kd_Aset84, A.Kd_Aset85, A.No_Register, 
			A.Kd_Ruang, A.Kd_Pemilik, A.Merk, A.Type,  A.CC, A.Bahan, A.Tgl_Dokumen, A.No_Dokumen, A.Tgl_Perolehan, 
			A.Tgl_Pembukuan, A.Nomor_Pabrik, A.Nomor_Rangka, A.Nomor_Mesin, A.Nomor_Polisi, 
	       A.Nomor_BPKB, A.Asal_usul, A.Kondisi, A.Harga, A.Masa_Manfaat, A.Nilai_Sisa, A.Keterangan, A.Tahun
	FROM Ta_KIBBR A INNER JOIN
		(
  ...
  INSERT INTO @UpdateKIB
   SELECT  A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, 
	       ...
	       B.Kd_Ruang, B.Kd_Pemilik, A.Harga, A.Masa_Manfaat, A.Nilai_Sisa, B.Tgl_Dokumen, B.No_Dokumen, 
	       B.Tgl_Perolehan, B.Tgl_Pembukuan, B.Merk, B.Type,  B.CC, B.Bahan, 
   ...
   FROM (
	...
	(
	SELECT  A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, 
			A.Kd_Aset,A.Kd_Aset0, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, MAX(A.Kd_Ruang) AS Kd_Ruang, 
