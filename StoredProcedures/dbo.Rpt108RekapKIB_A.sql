...
/*** Rpt108RekapKIB_A - 20022020 - Modified for Ver 2.0.7 [demi@simda.id] ***/
CREATE PROCEDURE dbo.Rpt108RekapKIB_A @Tahun varchar(4), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(10), @D2 Datetime
WITH ENCRYPTION
AS
/*
...
--*/
	...
	SELECT J.Kd_UPBA, I.Nm_Provinsi, H.Nm_Kab_Kota,
		...
		RIGHT('000000' + CONVERT(varchar, A.No_Register), 6) AS No_Register, A.Luas_M2, YEAR(A.Tgl_Perolehan) AS Tahun, A.Alamat, A.Hak_Tanah, A.Sertifikat_Tanggal, A.Sertifikat_Nomor,
		A.Penggunaan, A.Asal_usul, A.Harga / 1000 AS Harga, A.Keterangan, 
