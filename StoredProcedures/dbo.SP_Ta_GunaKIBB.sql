...
CREATE PROCEDURE [dbo].[SP_Ta_GunaKIBB] @SK_Guna varchar(50)
WITH ENCRYPTION
AS
...
SELECT	Kd_Prov, Kd_Kab_Kota, Kd_Bidang, Kd_Unit, Kd_Sub, Kd_UPB, Kd_Aset1, Kd_Aset2, Kd_Aset3, Kd_Aset4, Kd_Aset5, No_Register,
	Kd_Ruang, Kd_Pemilik, Merk, Type, CC, Bahan, Tgl_Perolehan, Tgl_Pembukuan, Nomor_Pabrik, Nomor_Rangka, Nomor_Mesin,
	Nomor_Polisi, Nomor_BPKB, Asal_usul, Kondisi, Harga, Masa_Manfaat, Nilai_Sisa, Keterangan, Tahun, No_SP2D, No_ID,
