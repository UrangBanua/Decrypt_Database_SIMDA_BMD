...
CREATE PROCEDURE [dbo].[SP_KIBBHapus] @No_SK varchar(50)
WITH ENCRYPTION
AS
...
SELECT  IDPemda, No_SK, Tgl_SK, Kd_Prov, Kd_Kab_Kota, Kd_Bidang, Kd_Unit, Kd_Sub, Kd_UPB, 
	...
	Asal_usul, Kondisi, Harga, Masa_Manfaat, Nilai_Sisa, Keterangan, Tahun, No_SP2D, No_ID, Kd_Kecamatan, Kd_Desa, Invent, Kd_Alasan, Kd_Penyusutan,
	REPLACE(dbo.fn_GabBarang(A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5), ' . ', '.')  AS GabBarang, No_SKGuna, Kd_KA,
