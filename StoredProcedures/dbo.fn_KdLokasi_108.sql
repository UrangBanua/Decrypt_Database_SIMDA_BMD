...
CREATE FUNCTION [dbo].[fn_KdLokasi_108] (@K1 varchar(2), @K2 varchar(2), @K3 varchar(2), @K4 varchar(2), @K5 varchar(2), @K6 varchar(2), @K7 varchar(3), @K8 varchar(10), @Thn varchar(4)) 
RETURNS varchar(30)
WITH ENCRYPTION
AS 
BEGIN
