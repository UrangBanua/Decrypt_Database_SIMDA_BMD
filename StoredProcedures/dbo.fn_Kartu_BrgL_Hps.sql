...
/*** fn_Kartu_BrgL - 08122017 - Modified for Ver 2.0.7 [demi@simda.id] ***/
CREATE FUNCTION dbo.fn_Kartu_BrgL_Hps (@D2 Datetime, @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(4),
...
RETURNS @UpdateKIB TABLE(Kd_Prov tinyint, Kd_Kab_Kota tinyint,  Kd_Bidang tinyint, Kd_Unit tinyint, Kd_Sub tinyint, Kd_UPB int, Kd_Aset1 tinyint, Kd_Aset2 tinyint, Kd_Aset3 tinyint, 
                         Kd_Aset4 tinyint, Kd_Aset5 tinyint, No_Register int, Kd_Ruang int, Kd_Pemilik tinyint, Tgl_Perolehan Datetime , Tgl_Pembukuan Datetime, Tgl_Dokumen Datetime, 
...
*/
	...
	DECLARE @tmpHarga TABLE(Kd_Prov tinyint, Kd_Kab_Kota tinyint, Kd_Bidang tinyint, Kd_Unit tinyint, Kd_Sub tinyint, Kd_UPB int, Kd_ASet1 tinyint, Kd_Aset2 tinyint, Kd_Aset3 tinyint, Kd_Aset4 tinyint, Kd_Aset5 tinyint, No_Register int, Harga money, Masa_Manfaat smallint, Nilai_Sisa money, Kd_Data tinyint, Kd_KA tinyint)
	...
	INSERT INTO @UbahData
	SELECT B.Kd_Prov1, B.Kd_Kab_Kota1, B.Kd_Bidang1, B.Kd_Unit1, B.Kd_Sub1, B.Kd_UPB1, 
	...
	WHERE   A.Tgl_Pembukuan <= @D2 AND B.Kd_Prov1 = @Kd_Prov AND B.Kd_Kab_Kota1 = @Kd_Kab_Kota AND B.Kd_Bidang1 LIKE @Kd_Bidang AND B.Kd_Unit1 LIKE @Kd_Unit AND B.Kd_Sub1 LIKE @Kd_Sub AND B.Kd_UPB1 LIKE @Kd_UPB AND
		A.Kd_Aset1 LIKE @Kd_Aset1 AND A.Kd_Aset2 LIKE @Kd_Aset2 AND A.Kd_Aset3 LIKE @Kd_Aset3 AND A.Kd_Aset4 LIKE @Kd_Aset4 AND A.Kd_Aset5 LIKE @Kd_Aset5 AND B.No_Register1 LIKE @No_Register
