...
CREATE PROCEDURE dbo.Rpt108BI_Gabungan @Tahun varchar(4), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(3), @D2 Datetime
WITH ENCRYPTION
AS
/*
...
--*/
	...
	SELECT J.Kd_BidangA, J.Kd_UnitA, J.Kd_SubA, J.Kd_UPBA, I.Nm_Provinsi, H.Nm_Kab_Kota, 
		...
		ELSE '000001 s/d ' + RIGHT('000000' + CONVERT(varchar, A.Total), 6)
		END AS No_Register, 
		CASE
