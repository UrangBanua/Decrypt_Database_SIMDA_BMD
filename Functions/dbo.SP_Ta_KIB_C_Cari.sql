...
CREATE PROCEDURE [dbo].[SP_Ta_KIB_C_Cari] @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(3), @Nm_Aset_Cari varchar(50)
WITH ENCRYPTION
AS
/*
