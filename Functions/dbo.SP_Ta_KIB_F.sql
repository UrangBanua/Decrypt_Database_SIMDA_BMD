...
CREATE PROCEDURE [dbo].[SP_Ta_KIB_F] @Tahun varchar(4), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(3), @Kd_Aset1 varchar(3)
WITH ENCRYPTION
AS
/*
...
*/
	SELECT A.IDPemda, A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB,
		...
		A.Kd_Pemilik, A.Tgl_Perolehan, A.Tgl_Pembukuan, A.Bertingkat_Tidak,
		A.Beton_tidak, A.Panjang, A.Lebar, A.Luas_Lantai, A.Lokasi, A.Dokumen_Tanggal, A.Dokumen_Nomor, A.Status_Tanah, 
		A.Kd_Tanah, A.Kd_Tanah0, A.Kd_Tanah1, A.Kd_Tanah2, A.Kd_Tanah3, A.Kd_Tanah4, A.Kd_Tanah5, A.Kode_Tanah, A.Asal_usul, 
		A.Kondisi, A.Harga, A.Keterangan, A.Kd_Kecamatan, A.Kd_Desa, A.Invent, A.Kd_Hapus,
