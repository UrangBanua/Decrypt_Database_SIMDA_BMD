...
CREATE  PROCEDURE [dbo].[SP_Ta_FotoB] @Tahun varchar(4), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(4), @Kd_Sub varchar(4), @Kd_UPB varchar(10),
