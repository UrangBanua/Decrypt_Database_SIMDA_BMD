...
/*** Rpt108RekapKIB_B - 20022020 - Modified for Ver 2.0.7 [demi@simda.id] ***/
CREATE PROCEDURE dbo.Rpt108RekapKIB_B @Tahun varchar(4), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(10), @D2 Datetime
WITH ENCRYPTION
AS
/*
...
--*/
    	...
    	DECLARE @Ta_KIB_B TABLE(Kd_Prov tinyint, Kd_Kab_Kota tinyint, Kd_Bidang tinyint, Kd_Unit smallint, Kd_Sub smallint, Kd_UPB bigint, Kd_Pemilik tinyint, Kd_Aset tinyint,Kd_Aset0 tinyint,Kd_Aset1 tinyint, Kd_Aset2 tinyint, Kd_Aset3 tinyint, Kd_Aset4 tinyint, Kd_Aset5 int, Reg1 int, Reg2 int, MerkType varchar(100), CC varchar(50), Bahan varchar(50), Tahun smallint, Nomor_Pabrik varchar(50), Nomor_Rangka varchar(50), Nomor_Mesin varchar(50), Nomor_Polisi varchar(10), Nomor_BPKB varchar(50), Asal_usul varchar(50), Harga money, Total int, Keterangan varchar(255))
	...
	FETCH NEXT FROM c1 INTO @Kd_Prov1, @Kd_Kab_Kota1, @Kd_Bidang1, @Kd_Unit1, @Kd_Sub1, @Kd_UPB1, @Kd_Pemilik1, @Kd_Aset1, @Kd_Aset01, @Kd_Aset11, @Kd_Aset21, @Kd_Aset31, @Kd_Aset41, @Kd_Aset51, @No_Register1, @MerkType1, @CC1, @Bahan1, @Tahun1, @Nomor_Pabrik1, @Nomor_Rangka1, @Nomor_Mesin1, @Nomor_Polisi1, @Nomor_BPKB1, @Asal_usul1, @Harga1, @Keterangan1
	...
	BEGIN
		...
		BEGIN
			...
			SELECT @Kd_Prov2, @Kd_Kab_Kota2, @Kd_Bidang2, @Kd_Unit2, @Kd_Sub2, @Kd_UPB2, @Kd_Pemilik2, @Kd_Aset1, @Kd_Aset01, @Kd_Aset12, @Kd_Aset22, @Kd_Aset32, @Kd_Aset42, @Kd_Aset52, @Reg1, @Reg2, @MerkType2, @CC2, @Bahan2, @Tahun2, @Nomor_Pabrik2, @Nomor_Rangka2, @Nomor_Mesin2, @Nomor_Polisi2, @Nomor_BPKB2, @Asal_usul2, @Harga2, @Jumlah, @Keterangan2
	...
	INSERT INTO @Ta_KIB_B
	SELECT @Kd_Prov2, @Kd_Kab_Kota2, @Kd_Bidang2, @Kd_Unit2, @Kd_Sub2, @Kd_UPB2, @Kd_Pemilik2, @Kd_Aset2, @Kd_Aset02, @Kd_Aset12, @Kd_Aset22, @Kd_Aset32, @Kd_Aset42, @Kd_Aset52, @Reg1, @Reg2, @MerkType2, @CC2, @Bahan2, @Tahun2, @Nomor_Pabrik2, @Nomor_Rangka2, @Nomor_Mesin2, @Nomor_Polisi2, @Nomor_BPKB2, @Asal_usul2, @Harga2, @Jumlah, @Keterangan2
	...
	FROM @Ta_KIB_B A INNER JOIN
		...
		) J WHERE (A.Kd_Aset = 1 AND A.Kd_Aset0 = 3 AND A.Kd_Aset1 = 2)
