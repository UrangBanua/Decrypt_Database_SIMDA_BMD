...
CREATE PROCEDURE dbo.Rpt108Rekap_Asetpindahgolongan @Tahun varchar(4), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), 
	@Kd_Sub varchar(3), @Kd_UPB varchar(3), @D2 datetime, @Kd_KIB varchar(1)
WITH ENCRYPTION
AS
---MENU REKAPPINDAH GOL(ASET)
--Rpt108Rekap_Asetpindahgolongan
...
-------------------------------------------------
	...
	SELECT 	
		...
		SUM (A.MutasiB + A.MutasiC + A.MutasiD + A.MutasiE + A.MutasikeB + A.MutasikeC + A.MutasikeD + A.MutasikeE ) AS Jumlah
