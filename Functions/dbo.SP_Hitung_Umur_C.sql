...
/*** SP_Hitung_Umur_C - 31082019 - Modified for Ver 2.0.7.11 [demi@simda.id] ***/
CREATE PROCEDURE SP_Hitung_Umur_C @Kd_Pemilik Varchar(3), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(3),
...
SET @Kd_Aset5	= '1'
SET @No_Register = '1'
SET @Tanggal = '20171201'
SET @Nilai = 200000000
SET @TipeA = 1 -- Penentuan Penyebut % Penambahan umur ekonomis  %  ---(1.Nilai Perolehan Akhir, 2. Nilai Perolehan Awal, 3.Nilai Buku) 
SET @TipeB = 1 -- Penambahan umur ekonomis di tahun yang sama ---(1.Semua Proses Kapitalisasi Menambah Umur Ekonomis pada Tahun Yang Sama 2.Hanya satu saja)
SET @TipeC = 1 -- Batasan maksimal penambahan umur ekonomis (1.Penambahan umur ekonomis tidak dapat melebihi umur ekonomis awal 2. ...dapat)
*/
                   ...
                   (
                    ...
                    FROM  
                        (
                         ...
                         FROM Ta_KIBCR A INNER JOIN @pindah B ON A.IDPemda = B.IDPemda AND A.Kd_ID = B.Kd_ID
                         WHERE A.IDPemda = @IDPemda
                        ) A
