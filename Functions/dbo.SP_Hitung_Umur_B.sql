...
/*** SP_Hitung_Umur_B - 31082019 - Modified for Ver 2.0.7.11 [demi@simda.id] ***/
CREATE PROCEDURE SP_Hitung_Umur_B @Kd_Pemilik Varchar(3), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(3),
