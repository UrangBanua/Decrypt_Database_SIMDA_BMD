...
/*** fn_UPB_E - 02032018 - Modified for Ver 2.0.7 [demi@simda.id] ***/
CREATE FUNCTION dbo.fn_UPB_E (@Tahun varchar(4), @D1 Datetime, @Kd_Prov tinyint, @Kd_Kab_Kota tinyint, @Kd_Bidang varchar(3), @Kd_Unit varchar(3), 
...
RETURNS @UPB TABLE(IDPemda varchar(17), Kd_Prov tinyint, Kd_Kab_Kota tinyint, Kd_Bidang tinyint, Kd_Unit smallint, Kd_Sub smallint, Kd_UPB int, 
                   Kd_Aset1 tinyint, Kd_Aset2 tinyint, Kd_Aset3 tinyint, Kd_Aset4 tinyint, Kd_Aset5 varchar(3), No_Register int, Tgl_Perolehan datetime)
...
*/
	...
	INSERT INTO @UPB
	    ...
	    (SELECT A.IDPemda,A.Kd_Prov,A.Kd_Kab_Kota,A.Kd_Bidang,A.Kd_Unit,A.Kd_Sub,A.Kd_UPB,A.Kd_Aset1,A.Kd_Aset2,A.Kd_Aset3,
                    A.Kd_Aset4,A.Kd_Aset5,A.No_Register,A.Tgl_Perolehan 
             ...
             SELECT A.IDPemda,A.Kd_Prov,A.Kd_Kab_Kota,A.Kd_Bidang,A.Kd_Unit,A.Kd_Sub,A.Kd_UPB,A.Kd_Aset1,A.Kd_Aset2,A.Kd_Aset3,
                    A.Kd_Aset4,A.Kd_Aset5,A.No_Register,A.Tgl_Perolehan
             FROM Ta_KIBER A INNER JOIN @pindah B ON A.IDPemda = B.IDPemda AND A.Kd_Id = B.Kd_Id 
            ) A
