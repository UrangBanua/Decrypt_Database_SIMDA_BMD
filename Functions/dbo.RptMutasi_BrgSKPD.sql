...
CREATE PROCEDURE dbo.RptMutasi_BrgSKPD @Tahun Varchar(4), @Kd_Prov Varchar(3), @Kd_Kab_Kota Varchar(3), @Kd_Bidang Varchar(3), @Kd_Unit Varchar(3),
...
DECLARE	@Mutasi_SKPD Table(Kd_Prov tinyint, Kd_Kab_Kota tinyint, Kd_Bidang tinyint, Kd_Unit smallint, Kd_Sub smallint, Kd_UPB smallint, Kd_Pemilik tinyint, Tgl_Pembukuan datetime,
	Kd_Aset1 int, Kd_Aset2 int, Kd_Aset3 int, Kd_Aset4 int, Kd_Aset5 int, No_Register int, Merk varchar(50), Type varchar(50), Dokumen varchar(100), Tgl_Dokumen datetime,
...
SELECT	A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Pemilik, A.Tgl_Pembukuan, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, 
...
--Pengurangan
	SELECT	A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, '' AS Kd_Pemilik, A.Tgl_Pembukuan, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, 
	...
	FROM
		...
		FROM	
			(
			SELECT	A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB,  A.Tgl_Pembukuan, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, 
				A.Merk, A.Type, A.Dokumen, A. Tgl_Dokumen, A.Bahan, A.Kondisi, 
			...
			FROM
				...
				FROM
					...
					FROM	Ta_KIBAR A LEFT OUTER JOIN
						fn_Kartu_BrgA_btw(@D1, @D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB, '%','%','%','%','%','%') B ON
						 ...
						 fn_Kartu_BrgA_Awl(@D1, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%') C ON
					...
					GROUP BY A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB,  A.Tgl_Pembukuan, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, A.Kd_Prov1,
						A.No_Dokumen, A. Tgl_Dokumen, A.Kd_Kab_Kota1, A.Kd_Bidang1, A.Kd_Unit1, A.Kd_Sub1, A.Kd_UPB1
			...
			FROM
				...
				FROM
					...
					FROM	Ta_KIBBR A LEFT OUTER JOIN
						fn_Kartu_BrgB_btw(@D1, @D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB, '%','%','%','%','%','%') B ON
							A.Kd_Prov = B.Kd_Prov AND A.Kd_Kab_Kota = B.Kd_Kab_Kota AND A.Kd_Bidang = B.Kd_Bidang AND A.Kd_Unit = B.Kd_Unit AND A.Kd_Sub = B.Kd_Sub AND A.Kd_UPB = B.Kd_UPB
							AND A.Kd_Aset1 = B.Kd_Aset1 AND A.Kd_Aset2 = B.Kd_Aset2 AND A.Kd_Aset3 = B.Kd_Aset3 AND A.Kd_Aset4 = B.Kd_Aset4 AND A.Kd_Aset5 = B.Kd_Aset5
							AND A.No_Register = B.No_Register LEFT OUTER JOIN 
						 fn_Kartu_BrgB_Awl(@D1, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%') C ON
										A.Kd_Prov = C.Kd_Prov AND A.Kd_Kab_Kota = C.Kd_Kab_Kota AND A.Kd_Bidang = C.Kd_Bidang AND A.Kd_Unit = C.Kd_Unit AND A.Kd_Sub = C.Kd_Sub AND A.Kd_UPB = C.Kd_UPB
										AND A.Kd_Aset1 = C.Kd_Aset1 AND A.Kd_Aset2 = C.Kd_Aset2 AND A.Kd_Aset3 = C.Kd_Aset3 AND A.Kd_Aset4 = C.Kd_Aset4 AND A.Kd_Aset5 = C.Kd_Aset5
										AND A.No_Register = C.No_Register
					WHERE	A.Kd_Prov = @Kd_Prov AND A.Kd_Kab_Kota = @Kd_Kab_Kota AND A.Kd_Bidang = @Kd_Bidang AND A.Kd_Unit = @Kd_Unit AND A.Kd_Sub = @Kd_Sub AND A.Kd_UPB = @Kd_UPB AND A.Kd_Riwayat = 3
			...
			FROM
				...
				FROM
					...
					FROM	Ta_KIBCR A LEFT OUTER JOIN
						fn_Kartu_BrgC_btw(@D1, @D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB, '%','%','%','%','%','%') B ON
										A.Kd_Prov = B.Kd_Prov AND A.Kd_Kab_Kota = B.Kd_Kab_Kota AND A.Kd_Bidang = B.Kd_Bidang AND A.Kd_Unit = B.Kd_Unit AND A.Kd_Sub = B.Kd_Sub AND A.Kd_UPB = B.Kd_UPB
										AND A.Kd_Aset1 = B.Kd_Aset1 AND A.Kd_Aset2 = B.Kd_Aset2 AND A.Kd_Aset3 = B.Kd_Aset3 AND A.Kd_Aset4 = B.Kd_Aset4 AND A.Kd_Aset5 = B.Kd_Aset5
										AND A.No_Register = B.No_Register LEFT OUTER JOIN 
						 fn_Kartu_BrgC_Awl(@D1, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%') C ON
										A.Kd_Prov = C.Kd_Prov AND A.Kd_Kab_Kota = C.Kd_Kab_Kota AND A.Kd_Bidang = C.Kd_Bidang AND A.Kd_Unit = C.Kd_Unit AND A.Kd_Sub = C.Kd_Sub AND A.Kd_UPB = C.Kd_UPB
										AND A.Kd_Aset1 = C.Kd_Aset1 AND A.Kd_Aset2 = C.Kd_Aset2 AND A.Kd_Aset3 = C.Kd_Aset3 AND A.Kd_Aset4 = C.Kd_Aset4 AND A.Kd_Aset5 = C.Kd_Aset5
										AND A.No_Register = C.No_Register
					...
					GROUP BY A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB,  A.Tgl_Pembukuan, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, A.Kd_Prov1,
						A.No_Dokumen, A. Tgl_Dokumen,A.Kondisi, A.Kd_Kab_Kota1, A.Kd_Bidang1, A.Kd_Unit1, A.Kd_Sub1, A.Kd_UPB1, C.Harga
					) A
				) A
			...
			FROM
				...
				FROM
					...
					FROM	Ta_KIBDR A LEFT OUTER JOIN
						fn_Kartu_BrgD_btw(@D1, @D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB, '%','%','%','%','%','%') B ON
							A.Kd_Prov = B.Kd_Prov AND A.Kd_Kab_Kota = B.Kd_Kab_Kota AND A.Kd_Bidang = B.Kd_Bidang AND A.Kd_Unit = B.Kd_Unit AND A.Kd_Sub = B.Kd_Sub AND A.Kd_UPB = B.Kd_UPB
							AND A.Kd_Aset1 = B.Kd_Aset1 AND A.Kd_Aset2 = B.Kd_Aset2 AND A.Kd_Aset3 = B.Kd_Aset3 AND A.Kd_Aset4 = B.Kd_Aset4 AND A.Kd_Aset5 = B.Kd_Aset5
							AND A.No_Register = B.No_Register LEFT OUTER JOIN 
						 fn_Kartu_BrgD_Awl(@D1, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%') C ON
										A.Kd_Prov = C.Kd_Prov AND A.Kd_Kab_Kota = C.Kd_Kab_Kota AND A.Kd_Bidang = C.Kd_Bidang AND A.Kd_Unit = C.Kd_Unit AND A.Kd_Sub = C.Kd_Sub AND A.Kd_UPB = C.Kd_UPB
										AND A.Kd_Aset1 = C.Kd_Aset1 AND A.Kd_Aset2 = C.Kd_Aset2 AND A.Kd_Aset3 = C.Kd_Aset3 AND A.Kd_Aset4 = C.Kd_Aset4 AND A.Kd_Aset5 = C.Kd_Aset5
										AND A.No_Register = C.No_Register
					WHERE	A.Kd_Prov = @Kd_Prov AND A.Kd_Kab_Kota = @Kd_Kab_Kota AND A.Kd_Bidang = @Kd_Bidang AND A.Kd_Unit = @Kd_Unit AND A.Kd_Sub = @Kd_Sub AND A.Kd_UPB = @Kd_UPB AND A.Kd_Riwayat = 3
			...
			FROM
				...
				FROM
					...
					FROM	Ta_KIBER A LEFT OUTER JOIN
						fn_Kartu_BrgE_btw(@D1, @D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB, '%','%','%','%','%','%') B ON
							A.Kd_Prov = B.Kd_Prov AND A.Kd_Kab_Kota = B.Kd_Kab_Kota AND A.Kd_Bidang = B.Kd_Bidang AND A.Kd_Unit = B.Kd_Unit AND A.Kd_Sub = B.Kd_Sub AND A.Kd_UPB = B.Kd_UPB
							AND A.Kd_Aset1 = B.Kd_Aset1 AND A.Kd_Aset2 = B.Kd_Aset2 AND A.Kd_Aset3 = B.Kd_Aset3 AND A.Kd_Aset4 = B.Kd_Aset4 AND A.Kd_Aset5 = B.Kd_Aset5
							AND A.No_Register = B.No_Register LEFT OUTER JOIN 
						 fn_Kartu_BrgE_Awl(@D1, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%') C ON
										A.Kd_Prov = C.Kd_Prov AND A.Kd_Kab_Kota = C.Kd_Kab_Kota AND A.Kd_Bidang = C.Kd_Bidang AND A.Kd_Unit = C.Kd_Unit AND A.Kd_Sub = C.Kd_Sub AND A.Kd_UPB = C.Kd_UPB
										AND A.Kd_Aset1 = C.Kd_Aset1 AND A.Kd_Aset2 = C.Kd_Aset2 AND A.Kd_Aset3 = C.Kd_Aset3 AND A.Kd_Aset4 = C.Kd_Aset4 AND A.Kd_Aset5 = C.Kd_Aset5
										AND A.No_Register = C.No_Register
					WHERE	A.Kd_Prov = @Kd_Prov AND A.Kd_Kab_Kota = @Kd_Kab_Kota AND A.Kd_Bidang = @Kd_Bidang AND A.Kd_Unit = @Kd_Unit AND A.Kd_Sub = @Kd_Sub AND A.Kd_UPB = @Kd_UPB AND A.Kd_Riwayat = 3
		...
		GROUP BY A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB,  A.Tgl_Pembukuan, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, 
...
--Penambahan
	...
	SELECT	A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, '' Kd_Pemilik, A.Tgl_Pembukuan, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, 
	...
	FROM
		(
		SELECT	A.Kd_Prov_B AS Kd_Prov, A.Kd_Kab_Kota_B AS Kd_Kab_Kota, A.Kd_Bidang_B AS Kd_Bidang, A.Kd_Unit_B AS Kd_Unit, A.Kd_Sub_B AS Kd_Sub, A.Kd_UPB_B AS Kd_UPB, '' Kd_Pemilik, A.Tgl_Pembukuan, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register1 AS No_Register, 
			A.Merk, A.Type, A.Dokumen, A. Tgl_Dokumen, A.Bahan, A.Kondisi,  0 AS Harga_Awal, 0 AS Pengurangan, SUM(A.Penambahan) AS Penambahan, 
			'-' AS Kd_Prov1, '-' AS Kd_Kab_Kota1, '-' AS Kd_Bidang1, '-' AS Kd_Unit1, '-' AS Kd_Sub1, '-' AS Kd_UPB1,
		...
		FROM
			(SELECT	A.Kd_Prov_B, A.Kd_Kab_Kota_B, A.Kd_Bidang_B, A.Kd_Unit_B, A.Kd_Sub_B, A.Kd_UPB_B,  A.Tgl_Pembukuan, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register1, 0 AS Harga_Awal, 0 AS Pengurangan, A.Penambahan, A.Kd_Prov_A,
				A.Merk, A.Type, A.Dokumen, A. Tgl_Dokumen, A.Bahan, A.Kondisi, 
				A.Kd_Kab_Kota_A, A.Kd_Bidang_A, A.Kd_Unit_A, A.Kd_Sub_A, A.Kd_UPB_A
			FROM
				(SELECT	A.Kd_Prov_B, A.Kd_Kab_Kota_B, A.Kd_Bidang_B, A.Kd_Unit_B, A.Kd_Sub_B, A.Kd_UPB_B,  A.Tgl_Pembukuan, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register1, A.Penambahan, A.Kd_Prov_A,
					A.Merk, A.Type, A.Dokumen, A. Tgl_Dokumen, A.Bahan, A.Kondisi, 
					A.Kd_Kab_Kota_A, A.Kd_Bidang_A, A.Kd_Unit_A, A.Kd_Sub_A, A.Kd_UPB_A
				FROM
					(
					SELECT	A.Kd_Prov AS Kd_Prov_A, A.Kd_Kab_Kota AS Kd_Kab_Kota_A, A.Kd_Bidang AS Kd_Bidang_A, A.Kd_Unit AS Kd_Unit_A, A.Kd_Sub AS Kd_Sub_A, A.Kd_UPB AS Kd_UPB_A,  A.Tgl_Pembukuan, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, 
						'-' AS Merk, '-' AS Type, A.No_Dokumen AS Dokumen, A. Tgl_Dokumen, '-' AS Bahan, '-' AS Kondisi, 
						A.Kd_Aset5, A.No_Register1, ISNULL(SUM(B.Harga),0) AS Penambahan, A.Kd_Prov1 AS Kd_Prov_B, A.Kd_Kab_Kota1 AS Kd_Kab_Kota_B, 
					...
					FROM	Ta_KIBAR A LEFT OUTER JOIN
						fn_Kartu_BrgA_btw(@D1, @D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB, '%','%','%','%','%','%') B ON
							...
							AND A.Kd_Aset1 = B.Kd_Aset1 AND A.Kd_Aset2 = B.Kd_Aset2 AND A.Kd_Aset3 = B.Kd_Aset3 AND A.Kd_Aset4 = B.Kd_Aset4 AND A.Kd_Aset5 = B.Kd_Aset5
							AND A.No_Register1 = B.No_Register LEFT OUTER JOIN 
						 fn_Kartu_BrgA_Awl(@D1, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%') C ON
										A.Kd_Prov = C.Kd_Prov AND A.Kd_Kab_Kota = C.Kd_Kab_Kota AND A.Kd_Bidang = C.Kd_Bidang AND A.Kd_Unit = C.Kd_Unit AND A.Kd_Sub = C.Kd_Sub AND A.Kd_UPB = C.Kd_UPB
										AND A.Kd_Aset1 = C.Kd_Aset1 AND A.Kd_Aset2 = C.Kd_Aset2 AND A.Kd_Aset3 = C.Kd_Aset3 AND A.Kd_Aset4 = C.Kd_Aset4 AND A.Kd_Aset5 = C.Kd_Aset5
										AND A.No_Register = C.No_Register
					WHERE	A.Kd_Prov1 = @Kd_Prov AND A.Kd_Kab_Kota1 = @Kd_Kab_Kota AND A.Kd_Bidang1 = @Kd_Bidang AND A.Kd_Unit1 = @Kd_Unit AND A.Kd_Sub1 = @Kd_Sub AND A.Kd_UPB1 = @Kd_UPB AND A.Kd_Riwayat = 3
							AND A.Tgl_Dokumen BETWEEN @D1 AND @D2
					GROUP BY A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB,  A.Tgl_Pembukuan, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register1, A.Kd_Prov1,
						A.No_Dokumen, A. Tgl_Dokumen,A.Kd_Kab_Kota1, A.Kd_Bidang1, A.Kd_Unit1, A.Kd_Sub1, A.Kd_UPB1
					) A
				) A
		...
		GROUP BY A.Kd_Prov_B, A.Kd_Kab_Kota_B, A.Kd_Bidang_B, A.Kd_Unit_B, A.Kd_Sub_B, A.Kd_UPB_B, A.Tgl_Pembukuan, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register1, 
...
GROUP BY A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Pemilik, A.Tgl_Pembukuan, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, 
	 A.No_Register, A.Merk, A.Type, A.Dokumen, A.Tgl_DOkumen, A.Bahan, A.Kondisi, A.Harga_Awal, A.Pengurangan, A.Penambahan, A.Kd_Prov1,
	A.Kd_Kab_Kota1, A.Kd_Bidang1, A.Kd_Unit1, A.Kd_Sub1, A.Kd_UPB1,	
	A.Kd_Prov2, A.Kd_Kab_Kota2, A.Kd_Bidang2, A.Kd_Unit2, A.Kd_Sub2, A.Kd_UPB2
...
FROM	Ta_UPB A LEFT OUTER JOIN
	...
	FROM	@Mutasi_SKPD A LEFT OUTER JOIN
		...
		WHERE	A.Kd_Prov = @Kd_Prov AND A.Kd_Kab_Kota = @Kd_Kab_Kota AND A.Kd_Bidang = @Kd_Bidang AND A.Kd_Unit = @Kd_Unit AND
			...
			A.Kd_Aset1 = D.Kd_Aset1 AND A.Kd_Aset2 = D.Kd_Aset2 AND A.Kd_Aset3 = D.Kd_Aset3 AND A.Kd_Aset4 = D.Kd_Aset4 AND 
