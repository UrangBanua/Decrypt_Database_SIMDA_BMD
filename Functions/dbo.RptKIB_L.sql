...
/*** RptKIB_L - 03032017 - Modified for Ver 2.0.7 [demi@simda.id] ***/
CREATE PROCEDURE dbo.RptKIB_L @Tahun varchar(4), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(10), @D2 Datetime
WITH ENCRYPTION
AS
...
---   
	...
	SELECT  J.Kd_UPBA, I.Nm_Provinsi, H.Nm_Kab_Kota,
		...
		RIGHT('0000' + CONVERT(varchar, A.No_Register), 4) AS No_Register, YEAR(A.Tgl_Perolehan) AS Tahun, A.Judul, A.Pencipta, A.Bahan, A.Ukuran, 
