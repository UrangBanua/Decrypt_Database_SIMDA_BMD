...
CREATE FUNCTION [dbo].[fn_Kartu_BrgF_btw] (@D1 Datetime, @D2 Datetime, @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(3),
...
RETURNS @UpdateKIB TABLE(Kd_Prov tinyint, Kd_Kab_Kota tinyint, Kd_Bidang tinyint, Kd_Unit smallint, Kd_Sub smallint, Kd_UPB int,
			 ...
			 Kondisi varchar(2), Harga money, Keterangan varchar(255), Kd_KA tinyint, Kd_Mutasi tinyint )
...
/*
DECLARE @Tahun varchar(4), @D1 datetime, @D2 datetime, @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(3), @Kd_Aset1 varchar(3), @Kd_Aset2 varchar(3), @Kd_Aset3 varchar(3), @Kd_Aset4 varchar(3), @Kd_Aset5 varchar(3), @No_Register varchar(4)
SET @Tahun = '2011'
SET @D1 = '20110101'
SET @D2 = '20111231'
SET @Kd_Prov = '19'
...
*/
	...
	SELECT	A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register,
		...
		A.Kd_Tanah1, A.Kd_Tanah2, A.Kd_Tanah3, A.Kd_Tanah4, A.Kd_Tanah5, A.Kd_Tanah, A.Asal_Usul, A.Kondisi, A.Harga, A.Keterangan, A.Kd_KA, A.Kd_Mutasi
	FROM
            	(
		SELECT	A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, 
			...
			A.Asal_Usul, 1 AS Kondisi, A.Harga, A.Keterangan, A.Kd_Data, A.Kd_KA, 1 AS Kd_Mutasi
		FROM	Ta_KIB_A A
		WHERE	(Kd_Prov = @Kd_Prov) AND (Kd_Kab_Kota = @Kd_Kab_Kota) AND (Kd_Bidang LIKE @Kd_Bidang) AND (Kd_Unit LIKE @Kd_Unit) AND (Kd_Sub LIKE @Kd_Sub) AND (Kd_UPB LIKE @Kd_UPB) 
			AND (A.Kd_Data = 3) AND (Tgl_Pembukuan BETWEEN @D1 AND @D2)
		...
		SELECT	A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, 
			...
			'' AS Status_Tanah, '' AS Kd_Tanah1, '' AS Kd_Tanah2, '' AS Kd_Tanah3, '' AS Kd_Tanah4, '' AS Kd_Tanah5, '' AS Kd_Tanah, 
			A.Asal_Usul, A.Kondisi, A.Harga, A.Keterangan, A.Kd_Data, A.Kd_KA, 1 AS Kd_Mutasi
		FROM	Ta_KIB_B A
		WHERE	(Kd_Prov = @Kd_Prov) AND (Kd_Kab_Kota = @Kd_Kab_Kota) AND (Kd_Bidang LIKE @Kd_Bidang) AND (Kd_Unit LIKE @Kd_Unit) AND (Kd_Sub LIKE @Kd_Sub) AND (Kd_UPB LIKE @Kd_UPB) 
			 AND (A.Kd_Data = 3) AND (Tgl_Pembukuan BETWEEN @D1 AND @D2)
		...
		SELECT	A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, 
			...
			A.Kd_Tanah1, A.Kd_Tanah2, A.Kd_Tanah3, A.Kd_Tanah4, A.Kd_Tanah5, A.Kode_Tanah, A.Asal_Usul, A.Kondisi, A.Harga, A.Keterangan, A.Kd_Data, A.Kd_KA, 1 AS Kd_Mutasi
		FROM	Ta_KIB_C A
		WHERE	(Kd_Prov = @Kd_Prov) AND (Kd_Kab_Kota = @Kd_Kab_Kota) AND (Kd_Bidang LIKE @Kd_Bidang) AND (Kd_Unit LIKE @Kd_Unit) AND (Kd_Sub LIKE @Kd_Sub) AND (Kd_UPB LIKE @Kd_UPB) 
                        AND (A.Kd_Data = 3) AND (Tgl_Pembukuan BETWEEN @D1 AND @D2)
		...
		SELECT	A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, 
			...
			'' AS Status_Tanah, '' AS Kd_Tanah1, '' AS Kd_Tanah2, '' AS Kd_Tanah3, '' AS Kd_Tanah4, '' AS Kd_Tanah5, '' AS Kd_Tanah, 
			A.Asal_Usul, A.Kondisi AS Kondisi, A.Harga, A.Keterangan, A.Kd_Data, A.Kd_KA, 1 AS Kd_Mutasi
		FROM	Ta_KIB_E A
		WHERE	(Kd_Prov = @Kd_Prov) AND (Kd_Kab_Kota = @Kd_Kab_Kota) AND (Kd_Bidang LIKE @Kd_Bidang) AND (Kd_Unit LIKE @Kd_Unit) AND (Kd_Sub LIKE @Kd_Sub) AND (Kd_UPB LIKE @Kd_UPB) 
			AND (A.Kd_Data = 3) AND (Tgl_Pembukuan BETWEEN @D1 AND @D2)
---                
		...
		FROM	Ta_KIBAR A
		WHERE	(Kd_Prov = @Kd_Prov) AND (Kd_Kab_Kota = @Kd_Kab_Kota) AND (Kd_Bidang LIKE @Kd_Bidang) AND (Kd_Unit LIKE @Kd_Unit) AND (Kd_Sub LIKE @Kd_Sub) AND (Kd_UPB LIKE @Kd_UPB) 
			AND (A.Kd_Data = 3) AND (A.Tgl_Pembukuan <= @D2) AND (Tgl_Dokumen BETWEEN @D1 AND @D2) AND (Tgl_Pembukuan >= @D1)
...
---
			...
			A.Kd_Pemilik, A.Tgl_Perolehan, A.Tgl_Pembukuan, '' AS Bertingkat_Tidak, '' Beton_Tidak, A.Luas_M2 AS Luas_Lantai, A.Alamat AS Lokasi, A.Tgl_Perolehan AS Dokumen_Tanggal, A.Sertifikat_Nomor AS Dokumen_Nomor, 
			'' AS Status_Tanah, '' AS Kd_Tanah1, '' AS Kd_Tanah2, '' AS Kd_Tanah3, '' AS Kd_Tanah4, '' AS Kd_Tanah5, '' AS Kd_Tanah, 
			A.Asal_Usul, 1 AS Kondisi, A.Harga, A.Keterangan, A.Kd_Data, A.Kd_KA, 3 AS Kd_Mutasi
		FROM	Ta_KIBAR A
		WHERE	(Kd_Prov = @Kd_Prov) AND (Kd_Kab_Kota = @Kd_Kab_Kota) AND (Kd_Bidang LIKE @Kd_Bidang) AND (Kd_Unit LIKE @Kd_Unit) AND (Kd_Sub LIKE @Kd_Sub) AND (Kd_UPB LIKE @Kd_UPB) 
			AND (A.Kd_Data = 3) AND (A.Tgl_Pembukuan <= @D2) AND (Tgl_Dokumen BETWEEN @D1 AND @D2)
		...
		SELECT	A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, 
			A.Kd_Pemilik, A.Tgl_Perolehan, A.Tgl_Pembukuan, '' AS Bertingkat_Tidak, '' Beton_Tidak, '' AS Luas_Lantai, '' AS Lokasi, A.Tgl_Perolehan AS Dokumen_Tanggal, A.Nomor_BPKB AS Dokumen_Nomor, 
			'' AS Status_Tanah, '' AS Kd_Tanah1, '' AS Kd_Tanah2, '' AS Kd_Tanah3, '' AS Kd_Tanah4, '' AS Kd_Tanah5, '' AS Kd_Tanah, 
			A.Asal_Usul, A.Kondisi, A.Harga, A.Keterangan, A.Kd_Data, A.Kd_KA, 3 AS Kd_Mutasi
		FROM	Ta_KIBBR A
		WHERE	(Kd_Prov = @Kd_Prov) AND (Kd_Kab_Kota = @Kd_Kab_Kota) AND (Kd_Bidang LIKE @Kd_Bidang) AND (Kd_Unit LIKE @Kd_Unit) AND (Kd_Sub LIKE @Kd_Sub) AND (Kd_UPB LIKE @Kd_UPB) 
			 AND (A.Kd_Data = 3) AND (A.Tgl_Pembukuan <= @D2) AND (Tgl_Dokumen BETWEEN @D1 AND @D2)
		...
		SELECT	A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, 
			A.Kd_Pemilik, A.Tgl_Perolehan, A.Tgl_Pembukuan, A.Bertingkat_Tidak, A.Beton_Tidak, A.Luas_Lantai, A.Lokasi, A.Dokumen_Tanggal, A.Dokumen_Nomor, A.Status_Tanah,
			A.Kd_Tanah1, A.Kd_Tanah2, A.Kd_Tanah3, A.Kd_Tanah4, A.Kd_Tanah5, A.Kode_Tanah, A.Asal_Usul, A.Kondisi, A.Harga, A.Keterangan, A.Kd_Data, A.Kd_KA, 3 AS Kd_Mutasi
		FROM	Ta_KIBCR A
		WHERE	(Kd_Prov = @Kd_Prov) AND (Kd_Kab_Kota = @Kd_Kab_Kota) AND (Kd_Bidang LIKE @Kd_Bidang) AND (Kd_Unit LIKE @Kd_Unit) AND (Kd_Sub LIKE @Kd_Sub) AND (Kd_UPB LIKE @Kd_UPB) 
                        AND (A.Kd_Data = 3) AND (A.Tgl_Pembukuan <= @D2) AND (Tgl_Dokumen BETWEEN @D1 AND @D2)
		...
		SELECT	A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, 
			A.Kd_Pemilik, A.Tgl_Perolehan, A.Tgl_Pembukuan, '' AS Bertingkat_Tidak, '' Beton_Tidak, 0 AS Luas_Lantai, '' AS Lokasi, A.Tgl_Perolehan AS Dokumen_Tanggal, '' AS Dokumen_Nomor, 
			'' AS Status_Tanah, '' AS Kd_Tanah1, '' AS Kd_Tanah2, '' AS Kd_Tanah3, '' AS Kd_Tanah4, '' AS Kd_Tanah5, '' AS Kd_Tanah, 
			A.Asal_Usul, A.Kondisi AS Kondisi, A.Harga, A.Keterangan, A.Kd_Data, A.Kd_KA, 3 AS Kd_Mutasi
		FROM	Ta_KIBER A
		WHERE	(Kd_Prov = @Kd_Prov) AND (Kd_Kab_Kota = @Kd_Kab_Kota) AND (Kd_Bidang LIKE @Kd_Bidang) AND (Kd_Unit LIKE @Kd_Unit) AND (Kd_Sub LIKE @Kd_Sub) AND (Kd_UPB LIKE @Kd_UPB) 
			AND (A.Kd_Data = 3) AND (A.Tgl_Pembukuan <= @D2) AND (Tgl_Dokumen BETWEEN @D1 AND @D2)
		) A
