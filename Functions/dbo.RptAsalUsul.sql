...
CREATE PROCEDURE dbo.RptAsalUsul @Tahun varchar(4), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(3), @Asal varchar(15), @D2 Datetime
WITH ENCRYPTION
AS
/*
...
*/
	...
	GROUP BY J.Kd_BidangA, J.Kd_UnitA, J.Kd_SubA, J.Kd_UPBA, I.Nm_Provinsi, H.Nm_Kab_Kota,
			J.Nm_Bidang_Gab, J.Nm_Unit_Gab, J.Nm_Sub_Unit_Gab, J.Nm_UPB_Gab,
			B.Nm_Aset5, C.Nm_Aset4, D.Nm_Aset3, E.Nm_Aset2, F.Nm_Aset1,
			A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.Reg1,
			A.No_Sertifikat, A.Bahan, A.Ukuran, A.Satuan,
