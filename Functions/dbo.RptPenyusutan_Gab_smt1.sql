...
/*** RptPenyusutan_Gab_smt1 - 29012016 - Modified for Ver 2.0.7 [demi@simda.id] ***/
CREATE PROCEDURE dbo.RptPenyusutan_Gab_smt1 @Tahun varchar(4), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), 
...
SELECT  A.Jndt, A.Kd_Prov, C.Nm_Provinsi, A.Kd_Kab_Kota, C.Nm_Kab_Kota, A.Kd_Bidang, C.Nm_Bidang, A.Kd_Unit, C.Nm_Unit, A.Kd_Sub, C.Nm_Sub_Unit, A.Kd_UPB, C.Nm_UPB,
	...
	A.Nilai_Susut1, A.Akum_susut, A.Nilai_Sisa,
       ...
       (ISNULL(A.Nilai_Susut1,0)) AS Penyusutan, ISNULL(A.Akum_Susut,0) - (ISNULL(A.Nilai_Susut2,0)) AS AKP_Akhir, ISNULL(A.Nilai_Sisa,0) + (ISNULL(A.Nilai_Susut2,0)) AS Nilai_Buku
