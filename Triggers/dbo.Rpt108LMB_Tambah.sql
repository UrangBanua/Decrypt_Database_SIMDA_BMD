...
CREATE PROCEDURE dbo.Rpt108LMB_Tambah @Tahun varchar(4), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(3), @D1 datetime, @D2 datetime
WITH ENCRYPTION
AS
...
*/
        ...
        DECLARE @tmpBI_btw TABLE(Kd_Prov tinyint, Kd_Kab_Kota tinyint, Kd_Bidang tinyint, Kd_Unit tinyint, Kd_Sub smallint, Kd_UPB smallint, Kd_Aset tinyint, Kd_Aset0 tinyint, Kd_Aset1 tinyint, Kd_Aset2 tinyint, Kd_Aset3 tinyint, Kd_Aset4 tinyint, Kd_Aset5 smallint, Kd_Pemilik tinyint, No_Register int, 
	...
	FROM fn_Kartu108_BrgA_btw(@D1, @D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%','%','%')  A LEFT OUTER JOIN
		TA_KIB_A C ON A.KD_PROV = C.KD_PROV AND A.KD_KAB_KOTA = C.KD_KAB_KOTA AND A.KD_BIDANG = C.KD_BIDANG AND A.KD_UNIT = C.KD_UNIT AND A.KD_SUB = C.KD_SUB AND A.KD_UPB = C.KD_UPB
				AND A.KD_ASET = C.KD_ASET8 AND A.KD_ASET0 = C.KD_ASET80 AND A.KD_ASET1 = C.KD_ASET81 AND A.KD_ASET2 = C.KD_ASET82 AND A.KD_ASET3 = C.KD_ASET83 AND A.KD_ASET4 = C.KD_ASET84 AND A.KD_ASET5 = C.KD_ASET85 AND A.NO_REGISTER = C.NO_REG8
	WHERE (A.Kd_Prov = @Kd_Prov) AND (A.Kd_Kab_Kota = @Kd_Kab_Kota) AND (A.Kd_Bidang LIKE @Kd_Bidang) AND (A.Kd_Unit LIKE @Kd_Unit) AND (A.Kd_Sub LIKE @Kd_Sub) AND (A.Kd_UPB LIKE @Kd_UPB)
		AND A.TGL_PEROLEHAN BETWEEN @D1 AND @D2 AND C.KD_HAPUS = 0 AND A.KD_ASET = 1 AND A.KD_ASET0 = 3 AND A.KD_ASET1 = 1
	...
	SELECT A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.KD_ASET, A.KD_ASET0, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5,
		...
		WHEN (ISNULL(REPLACE(A.Nomor_Pabrik, '-', ''), '') = '') AND (ISNULL(REPLACE(A.Nomor_Mesin, '-', ''), '') = '') THEN 
A.Nomor_Rangka
	...
	FROM fn_Kartu108_BrgB_btw(@D1, @D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%','%','%')  A LEFT OUTER JOIN
		...
		TA_KIB_B C ON A.KD_PROV = C.KD_PROV AND A.KD_KAB_KOTA = C.KD_KAB_KOTA AND A.KD_BIDANG = C.KD_BIDANG AND A.KD_UNIT = C.KD_UNIT AND A.KD_SUB = C.KD_SUB AND A.KD_UPB = C.KD_UPB
				AND A.KD_ASET = C.KD_ASET8 AND A.KD_ASET0 = C.KD_ASET80 AND A.KD_ASET1 = C.KD_ASET81 AND A.KD_ASET2 = C.KD_ASET82 AND A.KD_ASET3 = C.KD_ASET83 AND A.KD_ASET4 = C.KD_ASET84 AND A.KD_ASET5 = C.KD_ASET85 AND A.NO_REGISTER = C.NO_REG8
	WHERE (A.Kd_Prov = @Kd_Prov) AND (A.Kd_Kab_Kota = @Kd_Kab_Kota) AND (A.Kd_Bidang LIKE @Kd_Bidang) AND (A.Kd_Unit LIKE @Kd_Unit) AND (A.Kd_Sub LIKE @Kd_Sub) AND (A.Kd_UPB LIKE @Kd_UPB)
		AND A.TGL_PEROLEHAN BETWEEN @D1 AND @D2 AND C.KD_HAPUS = 0 AND A.KD_ASET = 1 AND A.KD_ASET0 = 3 AND A.KD_ASET1 = 2
	...
	FROM fn_Kartu108_BrgC_btw(@D1, @D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%','%','%')  A LEFT OUTER JOIN
		...
		TA_KIB_C C ON A.KD_PROV = C.KD_PROV AND A.KD_KAB_KOTA = C.KD_KAB_KOTA AND A.KD_BIDANG = C.KD_BIDANG AND A.KD_UNIT = C.KD_UNIT AND A.KD_SUB = C.KD_SUB AND A.KD_UPB = C.KD_UPB
				AND A.KD_ASET = C.KD_ASET8 AND A.KD_ASET0 = C.KD_ASET80 AND A.KD_ASET1 = C.KD_ASET81 AND A.KD_ASET2 = C.KD_ASET82 AND A.KD_ASET3 = C.KD_ASET83 AND A.KD_ASET4 = C.KD_ASET84 AND A.KD_ASET5 = C.KD_ASET85 AND A.NO_REGISTER = C.NO_REG8
	WHERE (A.Kd_Prov = @Kd_Prov) AND (A.Kd_Kab_Kota = @Kd_Kab_Kota) AND (A.Kd_Bidang LIKE @Kd_Bidang) AND (A.Kd_Unit LIKE @Kd_Unit) AND (A.Kd_Sub LIKE @Kd_Sub) AND (A.Kd_UPB LIKE @Kd_UPB)
		AND A.TGL_PEROLEHAN BETWEEN @D1 AND @D2 AND C.KD_HAPUS = 0 AND A.KD_ASET = 1 AND A.KD_ASET0 = 3 AND A.KD_ASET1 = 3
	...
	FROM fn_Kartu108_BrgD_btw(@D1, @D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%','%','%')  A LEFT OUTER JOIN
		...
		TA_KIB_D C ON A.KD_PROV = C.KD_PROV AND A.KD_KAB_KOTA = C.KD_KAB_KOTA AND A.KD_BIDANG = C.KD_BIDANG AND A.KD_UNIT = C.KD_UNIT AND A.KD_SUB = C.KD_SUB AND A.KD_UPB = C.KD_UPB
				AND A.KD_ASET = C.KD_ASET8 AND A.KD_ASET0 = C.KD_ASET80 AND A.KD_ASET1 = C.KD_ASET81 AND A.KD_ASET2 = C.KD_ASET82 AND A.KD_ASET3 = C.KD_ASET83 AND A.KD_ASET4 = C.KD_ASET84 AND A.KD_ASET5 = C.KD_ASET85 AND A.NO_REGISTER = C.NO_REG8
	WHERE (A.Kd_Prov = @Kd_Prov) AND (A.Kd_Kab_Kota = @Kd_Kab_Kota) AND (A.Kd_Bidang LIKE @Kd_Bidang) AND (A.Kd_Unit LIKE @Kd_Unit) AND (A.Kd_Sub LIKE @Kd_Sub) AND (A.Kd_UPB LIKE @Kd_UPB)
		AND A.TGL_PEROLEHAN BETWEEN @D1 AND @D2 AND C.KD_HAPUS = 0 AND A.KD_ASET = 1 AND A.KD_ASET0 = 3 AND A.KD_ASET1 = 4
	...
	FROM fn_Kartu108_BrgE_btw(@D1, @D2,@Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%','%','%')  A LEFT OUTER JOIN
		...
		TA_KIB_E C ON A.KD_PROV = C.KD_PROV AND A.KD_KAB_KOTA = C.KD_KAB_KOTA AND A.KD_BIDANG = C.KD_BIDANG AND A.KD_UNIT = C.KD_UNIT AND A.KD_SUB = C.KD_SUB AND A.KD_UPB = C.KD_UPB
				AND A.KD_ASET = C.KD_ASET8 AND A.KD_ASET0 = C.KD_ASET80 AND A.KD_ASET1 = C.KD_ASET81 AND A.KD_ASET2 = C.KD_ASET82 AND A.KD_ASET3 = C.KD_ASET83 AND A.KD_ASET4 = C.KD_ASET84 AND A.KD_ASET5 = C.KD_ASET85 AND A.NO_REGISTER = C.NO_REG8
	WHERE (A.Kd_Prov = @Kd_Prov) AND (A.Kd_Kab_Kota = @Kd_Kab_Kota) AND (A.Kd_Bidang LIKE @Kd_Bidang) AND (A.Kd_Unit LIKE @Kd_Unit) AND (A.Kd_Sub LIKE @Kd_Sub) AND (A.Kd_UPB LIKE @Kd_UPB)
		AND A.TGL_PEROLEHAN BETWEEN @D1 AND @D2 AND C.KD_HAPUS = 0 AND A.KD_ASET = 1 AND A.KD_ASET0 = 3 AND A.KD_ASET1 = 5
	...
	FROM fn_Kartu108_BrgL_btw(@D1, @D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%','%','%')  A LEFT OUTER JOIN
...
---------------
	...
	(
		...
		SELECT A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, 
			A.Kd_Aset, A.Kd_Aset0, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.Kd_Pemilik,A.Tgl_Perolehan, A.Tgl_Pembukuan,
	...
	GROUP BY J.Kd_UPBA, I.Nm_Provinsi, I.Nm_Provinsi, A.Kd_Kab_Kota, H.Nm_Kab_Kota, F.Nm_Bidang , E.Nm_Unit, D.Nm_Sub_Unit, J.Nm_UPB_Gab,
		K.Nm_Pemilik, A.Kd_Pemilik, A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, B.Nm_Aset5, A.Kd_Aset, A.Kd_Aset0, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5,
