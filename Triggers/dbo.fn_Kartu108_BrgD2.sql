...
CREATE FUNCTION dbo.fn_Kartu108_BrgD2 (@D2 Datetime, @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(4),
...
*/
	...
	IF ISNULL (@No_Register,'') = '' SET @No_Register = '%'
    	...
    	SELECT A.IDPemda, A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Aset, A.Kd_Aset0, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, 
	       	...
	       	A.Kondisi, A.Harga, A.Masa_Manfaat, A.Nilai_Sisa, A.Keterangan, A.Kd_KA
    		FROM fn_Kartu108_BrgD(@D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'1','3','4','%','%','%','%','%',@JLap)  A
		-- WHERE (A.Kd_Aset = 1 AND A.Kd_Aset0 = 3 AND A.Kd_Aset1 = 4) 


    	INSERT INTO @UpdateKIB
    	SELECT A.IDPemda, A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Aset, A.Kd_Aset0, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, 
	       	A.No_Register, A.Kd_Pemilik, A.Tgl_Perolehan, A.Tgl_Pembukuan, NULL AS Konstruksi, NULL AS Panjang, NULL AS Lebar, NULL AS Luas, NULL AS Lokasi, A.Tgl_Dokumen AS Dokumen_Tanggal, 
		A.No_Dokumen Dokumen_Nomor, NULL AS Status_Tanah, NULL AS Kd_Tanah1, NULL AS Kd_Tanah2, NULL AS Kd_Tanah3, NULL AS Kd_Tanah4, NULL AS Kd_Tanah5, NULL AS Kode_Tanah, A.Asal_usul, 
		A.Kondisi, A.Harga, A.Masa_Manfaat, A.Nilai_Sisa, A.Keterangan, A.Kd_KA
    		FROM fn_Kartu108_BrgB(@D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'1','3','4','%','%','%','%','%',@JLap)  A
		-- WHERE (A.Kd_Aset = 1 AND A.Kd_Aset0 = 3 AND A.Kd_Aset1 = 4) 


    	INSERT INTO @UpdateKIB
    	SELECT A.IDPemda, A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Aset, A.Kd_Aset0, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, 
	       	A.No_Register, A.Kd_Pemilik, A.Tgl_Perolehan, A.Tgl_Pembukuan, NULL AS Konstruksi, NULL AS Panjang, NULL AS Lebar, A.Luas_Lantai AS Luas, A.Lokasi, A.Dokumen_Tanggal, 
		A.Dokumen_Nomor, A.Status_Tanah, A.Kd_Tanah1, A.Kd_Tanah2, A.Kd_Tanah3, A.Kd_Tanah4, A.Kd_Tanah5, A.Kode_Tanah, A.Asal_usul, 
		A.Kondisi, A.Harga, A.Masa_Manfaat, A.Nilai_Sisa, A.Keterangan, A.Kd_KA
    		FROM fn_Kartu108_BrgC(@D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'1','3','4','%','%','%','%','%',@JLap)  A
		-- WHERE (A.Kd_Aset = 1 AND A.Kd_Aset0 = 3 AND A.Kd_Aset1 = 4) 

    	INSERT INTO @UpdateKIB
    	SELECT A.IDPemda, A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Aset, A.Kd_Aset0, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, 
	       	A.No_Register, A.Kd_Pemilik, A.Tgl_Perolehan, A.Tgl_Pembukuan, NULL AS Konstruksi, NULL AS Panjang, NULL AS Lebar, NULL AS Luas, NULL AS Lokasi, A.Tgl_Dokumen AS Dokumen_Tanggal,
		A.No_Dokumen AS Dokumen_Nomor, NULL AS Status_Tanah, NULL AS Kd_Tanah1, NULL AS Kd_Tanah2, NULL AS Kd_Tanah3, NULL AS Kd_Tanah4, NULL AS Kd_Tanah5, NULL AS Kode_Tanah, A.Asal_usul,
	       	A.Kondisi, A.Harga, A.Masa_Manfaat, A.Nilai_Sisa, A.Keterangan, A.Kd_KA
    		FROM fn_Kartu108_BrgE(@D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'1','3','4','%','%','%','%','%',@JLap)  A
		-- WHERE (A.Kd_Aset = 1 AND A.Kd_Aset0 = 3 AND A.Kd_Aset1 = 4) 
