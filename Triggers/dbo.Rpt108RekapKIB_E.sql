...
/*** Rpt108RekapKIB_E - 20022020 - Modified for Ver 2.0.7 [demi@simda.id] ***/
CREATE  PROCEDURE dbo.Rpt108RekapKIB_E @Tahun varchar(4), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(10), @D2 Datetime
WITH ENCRYPTION
AS
/* 
...
-- */
	...
	SELECT A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Pemilik, A.Kd_Aset,A.Kd_Aset0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register,
		CASE A.Kd_Aset2
		WHEN 17 THEN
			CASE
	...
	WHERE (A.Kd_Prov = @Kd_Prov) AND (A.Kd_Kab_Kota = @Kd_Kab_Kota) AND (A.Kd_Bidang LIKE @Kd_Bidang) 
AND (A.Kd_Unit LIKE @Kd_Unit) AND (A.Kd_Sub LIKE @Kd_Sub) AND (A.Kd_UPB LIKE @Kd_UPB)

	OPEN c1

	FETCH NEXT FROM c1 INTO @Kd_Prov1, @Kd_Kab_Kota1, @Kd_Bidang1, @Kd_Unit1, @Kd_Sub1, @Kd_UPB1, @Kd_Pemilik1, @Kd_Aset1,@Kd_Aset01, @Kd_Aset11, @Kd_Aset21, @Kd_Aset31, @Kd_Aset41, @Kd_Aset51, @No_Register1, @JudulPencipta1, @Spesifikasi1, @AsalDaerah1, @Tahun1, @Pencipta1, @Bahan1, @Jenis1, @Ukuran1, @Satuan1, @Asal_usul1, @Harga1, @Keterangan1
	...
	BEGIN
		...
		BEGIN
			...
			SELECT @Kd_Prov2, @Kd_Kab_Kota2, @Kd_Bidang2, @Kd_Unit2, @Kd_Sub2, @Kd_UPB2, @Kd_Pemilik2, @Kd_Aset2, @Kd_Aset02, @Kd_Aset12, @Kd_Aset22, @Kd_Aset32, @Kd_Aset42, @Kd_Aset52, @Reg1, @Reg2, @JudulPencipta2, @Spesifikasi2, @AsalDaerah2, @Tahun2, @Pencipta2, @Bahan2, @Jenis2, @Ukuran2, @Satuan2, @Asal_usul2, @Harga2, @Jumlah, @Keterangan2
	...
	INSERT INTO @Ta_KIB_E
	SELECT @Kd_Prov2, @Kd_Kab_Kota2, @Kd_Bidang2, @Kd_Unit2, @Kd_Sub2, @Kd_UPB2, @Kd_Pemilik2, @Kd_Aset2, @Kd_Aset02, @Kd_Aset12, @Kd_Aset22, @Kd_Aset32, @Kd_Aset42, @Kd_Aset52, @Reg1, @Reg2, 
@JudulPencipta2, @Spesifikasi2, @AsalDaerah2, @Tahun2, @Pencipta2, @Bahan2, @Jenis2, @Ukuran2, @Satuan2, @Asal_usul2, @Harga2, @Jumlah, @Keterangan2
	...
	SELECT J.Kd_UPBA, I.Nm_Provinsi, H.Nm_Kab_Kota, 
		...
		dbo.fn_KdLokasi2_108(A.Kd_Pemilik, A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB) AS Kd_Lokasi_Grp,
