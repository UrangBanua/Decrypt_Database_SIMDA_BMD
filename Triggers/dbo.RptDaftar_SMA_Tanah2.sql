...
/*** RptDaftar_SMA_Tanah2 - 17012017 - Modified for Ver 2.0.7 [demi@simda.id] ***/
CREATE PROCEDURE dbo.RptDaftar_SMA_Tanah2 @Tahun varchar(4), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(3), @D2 Datetime
WITH ENCRYPTION
AS
/*
...
*/
	...
	SELECT A.Kd_Prov, A.Kd_Kab_Kota, C.Nm_Kab_Kota, A.Kd_Bidang, C.Nm_Bidang, A.Kd_Unit, C.Nm_Unit, A.Kd_Sub, C.Nm_Sub_Unit, A.Kd_UPB, C.Nm_UPB, C.Nm_UPB AS Lokasi, A.Kd_Aset_Gab, 
		...
		YEAR (A.Tgl_Perolehan) AS Tahun, A.Luas_M2 AS Luas, A.Sertifikat_Nomor AS IMB, A.Alamat,
	...
	FROM (
		SELECT Kd_Prov, Kd_Kab_Kota, Kd_Bidang, Kd_Unit, Kd_Sub, Kd_UPB, Kd_Aset1, Kd_Aset2, Kd_Aset3, Kd_Aset4, Kd_Aset5, Tgl_Perolehan, No_Register, Kd_KA, Harga,
			...
			, Luas_M2, Sertifikat_Nomor, Keterangan, Alamat    
		FROM   fn_Kartu_BrgA(@D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%',@JLap)
	...
	GROUP BY A.Kd_Prov, A.Kd_Kab_Kota, C.Nm_Kab_Kota, A.Kd_Bidang, C.Nm_Bidang, A.Kd_Unit, C.Nm_Unit, A.Kd_Sub, C.Nm_Sub_Unit, A.Kd_UPB, C.Nm_UPB, C.Nm_UPB, A.Kd_Aset_Gab, 
		D.Kd_Aset1, D.Nm_Aset1, D.Kd_Aset2, D.Nm_Aset2, D.Kd_Aset3, D.Nm_Aset3, D.Kd_Aset4, D.Nm_Aset4, D.Kd_Aset5, D.Nm_Aset5, A.No_Register, 
		A.Tgl_Perolehan, A.Luas_M2, A.Sertifikat_Nomor, A.Alamat,
		A.Harga, A.Keterangan,    
		G.NO_BAST, G.TANGGAL,
	   	B.Nm_Pimpinan, B.Nip_Pimpinan, B.Jbt_Pimpinan, B.Nm_Pengurus, B.Nip_Pengurus, B.Jbt_Pengurus

	ORDER BY D.Kd_Aset1, D.Kd_Aset2, D.Kd_Aset3, D.Kd_Aset4, D.Kd_Aset5, A.No_Register
