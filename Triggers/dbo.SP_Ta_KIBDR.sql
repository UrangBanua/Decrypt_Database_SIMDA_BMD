...
CREATE PROCEDURE SP_Ta_KIBDR @Riwayat varchar(3), @IDPemda varchar(17), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(3),
...
SELECT A.IDPemda, A.No_Urut, A.Kd_Riwayat, A.Kd_Id, A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register,
	...
	A.Kd_Pemilik, A.Tgl_Dokumen, A.No_Dokumen, A.Tgl_Perolehan, A.Tgl_Pembukuan, A.Konstruksi, A.Panjang, A.Lebar, A.Luas, A.Lokasi, A.Dokumen_Tanggal, A.Dokumen_Nomor, A.Status_Tanah, 
