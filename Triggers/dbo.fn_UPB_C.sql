...
/*** fn_UPB_C - 26032017 - Modified for Ver 2.0.7 [demi@simda.id] ***/
CREATE FUNCTION dbo.fn_UPB_C (@Tahun varchar(4), @D1 Datetime, @Kd_Prov tinyint, @Kd_Kab_Kota tinyint, @Kd_Bidang varchar(3), @Kd_Unit varchar(3), 
