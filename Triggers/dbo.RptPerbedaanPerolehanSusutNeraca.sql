...
/*** RptPerbedaanPerolehanSusutNeraca - 21012016 - Modified for Ver 2.0.7 [demi@simda.id] ***/
CREATE PROCEDURE RptPerbedaanPerolehanSusutNeraca @Tahun varchar(4), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(3), @D1 datetime, @Kd_KIB varchar(1)
WITH ENCRYPTION
AS
/*
...
---------------------------------
	...
	DECLARE	@tmpnrc Table(IDPEMDA varchar (17), Kd_Prov tinyint, Kd_Kab_Kota tinyint, Kd_Bidang tinyint, Kd_Unit tinyint, Kd_Sub smallint, Kd_UPB smallint, Kd_Aset1 tinyint, Kd_Aset2 tinyint, Kd_Aset3 tinyint, 
		Kd_Aset4 tinyint, Kd_Aset5 tinyint, No_Register int, Harganrc money, HargaSusut money)
...
BEGIN
	...
	INSERT INTO @tmpnrc
	SELECT B.IDPEMDA, A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, A.Harga AS Harganrc, 0 as HargaSusut FROM 
			(
			SELECT A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, CASE WHEN A.Kondisi >= 3 OR B.Kd_Prov IS NOT NULL THEN 7 ELSE A.Kd_Aset1 END AS Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, 
			...
			FROM fn_Kartu_BrgB(@D1, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%',@JLap) A LEFT OUTER JOIN
			...
			WHERE (A.Kd_Prov = @Kd_Prov) AND (A.Kd_Kab_Kota = @Kd_Kab_Kota) AND (A.Kd_Bidang LIKE @Kd_Bidang) AND (A.Kd_Unit LIKE @Kd_Unit) AND (A.Kd_Sub LIKE @Kd_Sub) AND (A.Kd_UPB LIKE @Kd_UPB)
			      	AND (A.Kd_Pemilik = CASE WHEN @Kd_Kab_Kota = 0 THEN 11 ELSE 12 END) AND (A.KD_BIDANG <> 22) AND (A.Kd_KA = 1) and A.Kondisi < 3 
			) A INNER JOIN (
					SELECT IDPEMDA, Kd_Prov, Kd_Kab_Kota, Kd_Bidang, Kd_Unit, Kd_Sub, Kd_UPB, Kd_Aset1, Kd_Aset2, Kd_Aset3, Kd_Aset4, Kd_Aset5, No_Register
					FROM fn_UPB_B(@Tahun, @D1, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%') A
					) B ON A.Kd_Prov = B.Kd_Prov AND A.Kd_Kab_Kota = B.Kd_Kab_Kota AND A.Kd_Bidang = B.Kd_Bidang AND 
	...
	INSERT INTO @tmpnrc
	SELECT A.IDPEMDA, Kd_Prov, Kd_Kab_Kota, Kd_Bidang, Kd_Unit, Kd_Sub, Kd_UPB, Kd_Aset1, Kd_Aset2, Kd_Aset3, Kd_Aset4, Kd_Aset5, No_Register, 0 AS Harganrc, A.Harga as HargaSusut FROM 
	...
	CONVERT(varchar, A.Kd_ASET1) + '.' + CONVERT(varchar, A.Kd_ASET2) + '.' + CONVERT(varchar, A.Kd_ASET3) + '.' + RIGHT('0' + CONVERT(varchar, A.Kd_ASET4), 2) + '.' + RIGHT('0' + CONVERT(varchar, A.Kd_ASET5), 2) AS Kd_Gab_5,
	...
	FROM 
	(	
	SELECT A.IDPEMDA, B.IDPEMDA AS 'TanpaKIBHapus', C.IDPEMDA AS 'Bedakondisi', D.IDPEMDA AS 'BedaHargadgnRwyt', E.IDPEMDA AS 'TglBukuTglSKHapus', F.IDPEMDA AS 'RBJadiB', Kd_Prov, Kd_Kab_Kota, Kd_Bidang, Kd_Unit, Kd_Sub, Kd_UPB, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, X.Nm_Aset5, No_Register, Harganrc, HargaSusut 
	FROM (
	SELECT Max(IDPEMDA)AS IDPEMDA, Kd_Prov, Kd_Kab_Kota, Kd_Bidang, Kd_Unit, Kd_Sub, Kd_UPB, Kd_Aset1, Kd_Aset2, Kd_Aset3, Kd_Aset4, Kd_Aset5, No_Register, SUM(Harganrc) AS Harganrc, SUM(HargaSusut) AS HargaSusut 
	FROM @tmpnrc 
	GROUP BY Kd_Prov, Kd_Kab_Kota, Kd_Bidang, Kd_Unit, Kd_Sub, Kd_UPB, Kd_Aset1, Kd_Aset2, Kd_Aset3, Kd_Aset4, Kd_Aset5, No_Register
	having (SUM(Harganrc) - SUM(HargaSusut)) <> 0 
		) A 
	INNER JOIN REF_REK_ASET5 X ON A.Kd_Aset1 = X.Kd_Aset1 AND A.Kd_Aset2 = X.Kd_Aset2 AND A.Kd_Aset3 = X.Kd_Aset3 AND A.Kd_Aset4 = X.Kd_Aset4 AND A.Kd_Aset5 = X.Kd_Aset5 
...
-----
	...
	SELECT B.IDPEMDA, A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, A.Harga AS Harganrc, 0 as HargaSusut FROM 
			...
			SELECT A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, CASE WHEN A.Kondisi >= 3 OR B.Kd_Prov IS NOT NULL THEN 7 ELSE A.Kd_Aset1 END AS Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, 
				A.Harga , A.Masa_Manfaat AS Masa_ManfaatA, '' AS Tgl_DokumenA, A.Tgl_Perolehan AS Tgl_PerolehanA, A.Tgl_Pembukuan AS Tgl_PembukuanA, A.Kondisi AS KondisiA
			FROM fn_Kartu_BrgC(@D1, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%',@JLap) A LEFT OUTER JOIN
	      		       (SELECT Kd_Prov, Kd_Kab_Kota, Kd_Bidang, Kd_Unit, Kd_Sub, Kd_UPB, Kd_Aset1, Kd_Aset2, Kd_Aset3, Kd_Aset4, Kd_Aset5, No_Register  
               			FROM Ta_KIBCR 
                		WHERE Kd_Riwayat IN(9,10,11,12,13) AND Tgl_Dokumen <= @D1
                		GROUP BY Kd_Prov, Kd_Kab_Kota, Kd_Bidang, Kd_Unit, Kd_Sub, Kd_UPB, Kd_Aset1, Kd_Aset2, Kd_Aset3, Kd_Aset4, Kd_Aset5, No_Register
...
BEGIN
	...
	SELECT B.IDPEMDA, A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, A.Harga AS Harganrc, 0 as HargaSusut FROM 
			...
			SELECT A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, CASE WHEN A.Kondisi >= 3 OR B.Kd_Prov IS NOT NULL THEN 7 ELSE A.Kd_Aset1 END AS Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, 
				A.Harga , A.Masa_Manfaat AS Masa_ManfaatA, '' AS Tgl_DokumenA, A.Tgl_Perolehan AS Tgl_PerolehanA, A.Tgl_Pembukuan AS Tgl_PembukuanA, A.Kondisi AS KondisiA
			FROM fn_Kartu_BrgD(@D1, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%',@JLap) A LEFT OUTER JOIN
	      		       (SELECT Kd_Prov, Kd_Kab_Kota, Kd_Bidang, Kd_Unit, Kd_Sub, Kd_UPB, Kd_Aset1, Kd_Aset2, Kd_Aset3, Kd_Aset4, Kd_Aset5, No_Register  
               			FROM Ta_KIBDR 
                		WHERE Kd_Riwayat IN(9,10,11,12,13) AND Tgl_Dokumen <= @D1
                		GROUP BY Kd_Prov, Kd_Kab_Kota, Kd_Bidang, Kd_Unit, Kd_Sub, Kd_UPB, Kd_Aset1, Kd_Aset2, Kd_Aset3, Kd_Aset4, Kd_Aset5, No_Register
...
BEGIN
	...
	SELECT B.IDPEMDA, A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, A.Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, A.Harga AS Harganrc, 0 as HargaSusut FROM 
			...
			SELECT A.Kd_Prov, A.Kd_Kab_Kota, A.Kd_Bidang, A.Kd_Unit, A.Kd_Sub, A.Kd_UPB, CASE WHEN A.Kondisi >= 3 OR B.Kd_Prov IS NOT NULL THEN 7 ELSE A.Kd_Aset1 END AS Kd_Aset1, A.Kd_Aset2, A.Kd_Aset3, A.Kd_Aset4, A.Kd_Aset5, A.No_Register, 
				A.Harga , A.Masa_Manfaat AS Masa_ManfaatA, '' AS Tgl_DokumenA, A.Tgl_Perolehan AS Tgl_PerolehanA, A.Tgl_Pembukuan AS Tgl_PembukuanA, A.Kondisi AS KondisiA
			FROM fn_Kartu_BrgE(@D1, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%',@JLap) A LEFT OUTER JOIN
	      		       (SELECT Kd_Prov, Kd_Kab_Kota, Kd_Bidang, Kd_Unit, Kd_Sub, Kd_UPB, Kd_Aset1, Kd_Aset2, Kd_Aset3, Kd_Aset4, Kd_Aset5, No_Register  
               			FROM Ta_KIBER 
                		WHERE Kd_Riwayat IN(9,10,11,12,13) AND Tgl_Dokumen <= @D1
                		GROUP BY Kd_Prov, Kd_Kab_Kota, Kd_Bidang, Kd_Unit, Kd_Sub, Kd_UPB, Kd_Aset1, Kd_Aset2, Kd_Aset3, Kd_Aset4, Kd_Aset5, No_Register
