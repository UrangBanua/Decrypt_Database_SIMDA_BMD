...
CREATE PROCEDURE dbo.Rpt108RekapMutasiBarang @Tahun varchar(4), @Kd_Prov varchar(3), @Kd_Kab_Kota varchar(3), @Kd_Bidang varchar(3), @Kd_Unit varchar(3), @Kd_Sub varchar(3), @Kd_UPB varchar(10), @D1 Datetime, @D2 Datetime  
WITH ENCRYPTION
AS
...
--*/
	...
	IF ISNULL(@D1, '') = '' SET @D1 = Year(@D2)+'0101'
	...
	FROM
		...
		SELECT B.Kd_Pemilik, C.Nm_Pemilik, 
			CONVERT(varchar, A.Kd_Aset)+ '.' + CONVERT(varchar, A.Kd_Aset0)+ '.' + CONVERT(varchar, A.Kd_Aset1) +'.' + CONVERT(varchar, A.Kd_Aset2) AS Kd_Aset, UPPER(A.Nm_Aset2) AS Nm_Aset, 
		...
		FROM			
			Ref_Rek2_108 A LEFT OUTER JOIN
			(
			 SELECT B.Kd_Aset,B.Kd_Aset0,B.Kd_Aset1, B.Kd_Aset2, B.Kd_Pemilik, SUM(B.Jumlah) AS Jml_Awal, SUM(B.Harga) AS Harga_Awal, 0 AS Jml_Tambah, 0 AS Harga_Tambah, 0 AS Jml_Kurang, 0 AS Harga_Kurang
			 FROM
				(
				SELECT A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik,  
				...
				GROUP BY A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik
			
				UNION ALL
			
				SELECT A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik, 
					COUNT(*) AS Jumlah, SUM(A.Harga) AS Harga
				FROM fn_Kartu108_BrgB_Awl(@D1, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%','%','%')  A
				WHERE (A.Kd_Prov LIKE @Kd_Prov) AND (A.Kd_Kab_Kota LIKE @Kd_Kab_Kota) AND A.Kd_Bidang LIKE @Kd_Bidang AND A.Kd_Unit LIKE @Kd_Unit AND A.Kd_Sub LIKE @Kd_Sub AND A.Kd_UPB LIKE @Kd_UPB
				GROUP BY A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik
				...
				SELECT A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik, 
					COUNT(*) AS Jumlah, SUM(A.Harga) AS Harga
				FROM fn_Kartu108_BrgC_Awl(@D1, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%','%','%')  A
				WHERE (A.Kd_Prov LIKE @Kd_Prov) AND (A.Kd_Kab_Kota LIKE @Kd_Kab_Kota) AND A.Kd_Bidang LIKE @Kd_Bidang AND A.Kd_Unit LIKE @Kd_Unit AND A.Kd_Sub LIKE @Kd_Sub AND A.Kd_UPB LIKE @Kd_UPB
				GROUP BY A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik
				...
				SELECT A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik, 
					COUNT(*) AS Jumlah, SUM(A.Harga) AS Harga
				FROM fn_Kartu108_BrgD_Awl(@D1, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%','%','%')  A
				WHERE (A.Kd_Prov LIKE @Kd_Prov) AND (A.Kd_Kab_Kota LIKE @Kd_Kab_Kota) AND A.Kd_Bidang LIKE @Kd_Bidang AND A.Kd_Unit LIKE @Kd_Unit AND A.Kd_Sub LIKE @Kd_Sub AND A.Kd_UPB LIKE @Kd_UPB
				GROUP BY A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik
				...
				SELECT A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik,
					COUNT(*) AS Jumlah, SUM(A.Harga) AS Harga
				FROM fn_Kartu108_BrgE_Awl(@D1, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%','%','%')  A
				WHERE (A.Kd_Prov LIKE @Kd_Prov) AND (A.Kd_Kab_Kota LIKE @Kd_Kab_Kota) AND A.Kd_Bidang LIKE @Kd_Bidang AND A.Kd_Unit LIKE @Kd_Unit AND A.Kd_Sub LIKE @Kd_Sub AND A.Kd_UPB LIKE @Kd_UPB
				GROUP BY A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik
			...
			GROUP BY B.Kd_Aset,B.Kd_Aset0,B.Kd_Aset1, B.Kd_Aset2, B.Kd_Pemilik
			  
			UNION ALL
			
			SELECT C.Kd_Aset,C.Kd_Aset0,C.Kd_Aset1, C.Kd_Aset2, C.Kd_Pemilik, 0 AS Jml_Awal, 0 AS Harga_awal, SUM(C.Jumlah) AS Jml_Tambah, SUM(C.Harga) AS Harga_Tambah, 0 AS Jml_Kurang, 0 AS Harga_Kurang
			FROM
				(
				SELECT A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik,
				...
				SELECT	A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik, 
					SUM(A.Jml_Brg) AS Jumlah, SUM(A.Harga) AS Harga
				FROM fn_Kartu108_BrgB_btw(@D1, @D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%','%','%')  A
				WHERE	(A.Kd_Mutasi IN(1,2,4)) AND (A.Kd_Prov LIKE @Kd_Prov) AND (A.Kd_Kab_Kota LIKE @Kd_Kab_Kota) AND A.Kd_Bidang LIKE @Kd_Bidang AND A.Kd_Unit LIKE @Kd_Unit AND A.Kd_Sub LIKE @Kd_Sub AND A.Kd_UPB LIKE @Kd_UPB
				GROUP BY A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik
				...
				SELECT A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik, 
					SUM(A.Jml_Brg) AS Jumlah, SUM(A.Harga) AS Harga
				FROM fn_Kartu108_BrgC_btw(@D1, @D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%','%','%')  A
				WHERE (A.Kd_Mutasi IN(1,2,4)) AND (A.Kd_Prov LIKE @Kd_Prov) AND (A.Kd_Kab_Kota LIKE @Kd_Kab_Kota) AND A.Kd_Bidang LIKE @Kd_Bidang AND A.Kd_Unit LIKE @Kd_Unit AND A.Kd_Sub LIKE @Kd_Sub AND A.Kd_UPB LIKE @Kd_UPB
				GROUP BY A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik
				...
				SELECT A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik,
					SUM(A.Jml_Brg) AS Jumlah, SUM(A.Harga) AS Harga
				FROM fn_Kartu108_BrgD_btw(@D1, @D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%','%','%')  A
				WHERE (A.Kd_Mutasi IN(1,2,4)) AND (A.Kd_Prov LIKE @Kd_Prov) AND (A.Kd_Kab_Kota LIKE @Kd_Kab_Kota) AND A.Kd_Bidang LIKE @Kd_Bidang AND A.Kd_Unit LIKE @Kd_Unit AND A.Kd_Sub LIKE @Kd_Sub AND A.Kd_UPB LIKE @Kd_UPB
				GROUP BY A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik
				...
				SELECT A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik,
					SUM(A.Jml_Brg) AS Jumlah, SUM(A.Harga) AS Harga
				FROM fn_Kartu108_BrgE_Btw(@D1, @D2, @Kd_Prov, @Kd_Kab_Kota, @Kd_Bidang, @Kd_Unit, @Kd_Sub, @Kd_UPB,'%','%','%','%','%','%','%','%')  A
				WHERE (A.Kd_Mutasi IN(1,2,4)) AND (A.Kd_Prov LIKE @Kd_Prov) AND (A.Kd_Kab_Kota LIKE @Kd_Kab_Kota) AND A.Kd_Bidang LIKE @Kd_Bidang AND A.Kd_Unit LIKE @Kd_Unit AND A.Kd_Sub LIKE @Kd_Sub AND A.Kd_UPB LIKE @Kd_UPB
				GROUP BY A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik
			
				UNION ALL
			
				SELECT A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, 20 AS Kd_Aset2, A.Kd_Pemilik, 
					COUNT(*) AS Jumlah, SUM(A.Harga) AS Harga
			...
			GROUP BY C.Kd_Aset,C.Kd_ASet0,C.Kd_Aset1, C.Kd_Aset2, C.Kd_Pemilik
			 
			UNION ALL
			
			SELECT C.Kd_Aset,C.Kd_ASet0, C.Kd_Aset1, C.Kd_Aset2, C.Kd_Pemilik, 0 AS Jml_Awal, 0 AS Harga_awal, 0 AS Jml_Tambah, 0 AS Harga_Tambah, SUM(C.Jumlah) AS Jml_Kurang, SUM(C.Harga) AS Harga_Kurang
			FROM
				(
				SELECT A.Kd_Aset,A.Kd_ASet0,A.Kd_Aset1, A.Kd_Aset2, A.Kd_Pemilik,  
					SUM(A.Jml_Brg) AS Jumlah, SUM(A.Harga) AS Harga
			...
			) B ON A.Kd_Aset = B.Kd_Aset AND A.Kd_Aset0 = B.Kd_ASet0 AND A.Kd_Aset1 = B.Kd_Aset1 AND A.Kd_Aset2 = B.Kd_Aset2 LEFT OUTER JOIN
			Ref_Pemilik C ON B.Kd_Pemilik = C.Kd_Pemilik
		GROUP BY A.Kd_Aset, A.Kd_Aset0, A.Kd_Aset1, A.Kd_Aset2, A.Nm_Aset2, B.Kd_Pemilik, C.Nm_Pemilik
